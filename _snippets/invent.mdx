...
<img src="/images/invent-panel.png" alt="The Invent panel showing its greeting, suggested actions, and the message composer" />
...
<AccordionGroup>
  ...
  <Accordion title="Workforces" icon="users-gear">
  ...
  <Accordion title="Evals and performance" icon="gauge">
  ...
  <Accordion title="Analytics and monitoring" icon="chart-line">
  ...
  <Accordion title="Integrations and MCP" icon="plug">
  ...
  <Accordion title="Working with you" icon="comments">
  ...
  <Accordion title="Project setup" icon="folder-tree">
...
<Tabs>
  ...
  <Accordion title="Scheduled check-ins" icon="calendar-clock">
    ...
    <Note>
      Before setting up a scheduled check-in, add an email or Slack notification channel in [Alerts](#alerts) so Invent can notify you about the result.
    </Note>
...
<Tabs>
  ...
  <Tab title="Configure an alarm">
    ...
    Turn on **Auto-diagnosis by Invent** to investigate the first breach and send a diagnosis and proposed fix to the alarm creator's [Invent alert channels](#alerts). Invent still shares its findings if the cause is unclear and never applies changes without your approval.
