...
*  **What is wide/flatten format**
    ...
    An example is shown in the table below where the Categories column contains unique categorical values 
    ...
    categories, with zero/one values indicating if a category applies to the text response in
...
* **Access to wide format export**
    ...
    ![export](/images/general/export-wide-format.png)
