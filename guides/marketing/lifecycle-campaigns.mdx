...
<CardGroup cols={3}>
  ...
  <Card title="Let it improve" icon="arrows-rotate">
    Feed opens, clicks, and conversion back into the Agent's [evals](/build/operations/evals/introduction) so drafts track what converts.
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Brand-voice regressions" icon="clock-rotate-left">
    A prompt tweak changes tone everywhere. Use [evals](/build/operations/evals/introduction) on a few canonical drafts to catch drift before it ships to subscribers.
  </Accordion>
