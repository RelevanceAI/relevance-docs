...
<CardGroup cols={3}>
  ...
  <Card title="Let it improve" icon="arrows-rotate">
    Feed win/loss notes back into the Agent's [evals](/build/operations/evals/introduction) so it tracks the signals that matter.
  </Card>
</CardGroup>
...
<AccordionGroup>
  <Accordion title="Tracking too many competitors" icon="bell-slash">
