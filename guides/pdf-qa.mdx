...
We'll be creating more tooling and content around this process, but for now you can check out a simple [Google Colab showing how](https://colab.research.google.com/drive/17CGlVUzcE3kz0Oqy4qmi33CJPuTlLaav?usp=sharing). To run, you'll have to fill in your authentication details at the top of the notebook.
