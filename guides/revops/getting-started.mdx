...
For account-level enrichment, see the [CRM data enrichment](/guides/sales/crm-data-enrichment) motion in Sales — same shape, applies cleanly to RevOps use. For scoring inbound, see [Lead scoring](/guides/sales/lead-scoring).
