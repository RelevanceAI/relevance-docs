---
title: 'Agent that dashboards like an analyst'
...
<Tip>
    At the end of this guide, we'll link to a Github repo where you can checkout
    the code and run it yourself!
</Tip>
...
<div style="position: relative; padding-bottom: 61.57354618015963%; height: 0;">
    <iframe
