...
1. Select "Decide when to use" in the edge settings
...
When using "Decide when to use", the quality of your instructions in the "When to call this agent" field is crucial:
