...
<Info>
**Enterprise customers:** When sharing workforces with team members using RBAC, you'll need to grant permissions to both the workforce and all agents within it. Learn more about [Workforce Permissions in RBAC](/get-started/enterprise/rbac#workforce-permissions).
</Info>
