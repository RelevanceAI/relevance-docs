---
title: "Add, create, edit and connect Agents"
...
<AccordionGroup>
  <Accordion title="Agents aren't communicating as expected">Check the connection settings between Agents and ensure the instructions are clear and specific.</Accordion>
  <Accordion title="Workflow stops unexpectedly">Check if an Agent is waiting for approval in the Task View.</Accordion>
  <Accordion title="Agent makes incorrect decisions about when to delegate">Refine the natural language instructions in the "When to call this agent" field.</Accordion>
</AccordionGroup>