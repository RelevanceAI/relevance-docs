...
3. Configure the connection type:
   - **Decide when to use**: The agent will determine when to use the tool based on natural language instructions
...
- **Decide when to use**: Use natural language to explain when the tool should be used
