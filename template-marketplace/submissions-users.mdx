---
title: 'Template submission guide for users'
description: 'Submit your agent and tool templates to our marketplace'
---

# Template submission guide for users

## About our platform

Relevance AI is a powerful no-code platform that enables anyone to build specialized AI agents, tools, and multiagent systems without writing a single line of code. We've simplified the complex process of development, making it accessible to creators, professionals, and innovators across all industries.
...
When submitting your templates, please provide the following:

### 1. Clone link <span className="required">Required</span>
The direct link that allows others to replicate your AI agent or tool.

### 2. Personal information <span className="required">Required</span>
- Full name
- Email address for communication about your submission.

### 3. Demo video <span className="optional">Optional but Recommended</span>
- A short demonstration showing your agent or tool in action
- Highlight key features and practical applications

### 4. Agent/tool description <span className="required">Required</span>
- Clear, concise explanation of what your template does
- Key features and capabilities
- Specific use cases
- Target audience (e.g., marketers, researchers, educators)

### 5. Tags & Categories <span className="required">Required</span>
Select relevant tags to make your template easily discoverable

### 6. Dependencies <span className="optional">If Applicable</span>
List any external services or APIs your template requires

### 7. Social tracking <span className="optional">Optional</span>
Indicate if you'd like to be tagged when your tool is shared on social media.

### 8. License confirmation <span className="required">Required</span>
Confirm you have the rights to submit this solution and it doesn't violate third-party terms.
