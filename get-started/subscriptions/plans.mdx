...
<Tabs>
  <Tab title="New billing (Actions and Vendor Credits)">
    ...
    From this page, you will be able to see credit usage across your entire Organization, and view this by Agent or see a detailed view of your credit expenses. **As an Org Admin, you can also use date and project filters to gain deeper insights into your organization's spend and resource allocation.**

    #### Filtering by date

    The date selector allows you to view your organization's spend over specific time periods, making it easier to track usage trends and identify patterns in credit consumption.

    <Note>
      The date filter is particularly useful for analyzing spend during specific campaigns, projects, or billing periods.
    </Note>

    To filter your credit usage by date:

    1. On the Plan & Billing page, locate the date selector at the top of the usage dashboard
    2. Click the date selector to open the date picker
    3. Choose your desired time period (you can select a preset range or custom dates)
    4. The dashboard will automatically update to show usage data for the selected period

    <!-- TODO: Add screenshot showing the date selector interface -->

    #### Filtering by project

    The project selector helps you identify which projects are consuming credits, giving you visibility into how resources are allocated across your organization.

    <Tip>
      Use the project filter to understand which teams or initiatives are driving the most AI usage, helping you make informed decisions about resource allocation and budgeting.
    </Tip>

    To filter your credit usage by project:

    1. On the Plan & Billing page, locate the project selector at the top of the usage dashboard
    2. Click the project selector to view all available projects
    3. Select one or more projects to filter the usage data
    4. The dashboard will update to show credit consumption for the selected project(s)

    <!-- TODO: Add screenshot showing the project selector interface -->

    <!-- TODO: Add screenshot showing a filtered view with both date and project filters applied -->

    <Info>
      You can combine both date and project filters to get a holistic view of specific project spend over particular time periods.
    </Info>
