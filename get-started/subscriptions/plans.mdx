...
<Tabs>
  <Tab title="New billing (Actions and Vendor Credits)">
    ...
    <Tip>
      You can also set up automatic top-ups with [Spend Controls](/get-started/subscriptions/spend-controls) to ensure your account never runs out of credits unexpectedly.
    </Tip>
