...
<CardGroup cols={2}>
  ...
  <Card title="Resource search" icon="layer-group">
    Jump directly to any agent, tool, workforce, knowledge set, or Invent chat conversation in your project
  </Card>
...
If Invent is enabled in your project, you can also search your Invent chat conversations by title. Only titled conversations appear — untitled ones are excluded. Up to 100 of your most recent conversations are indexed when the palette first opens, scoped to conversations you created. Clicking a result opens that conversation.
