...
<Info>
Want to learn more about the Marketplace? Check out our [Marketplace overview](/get-started/marketplace/introduction) to discover how it works and what's available.
</Info>
...
<CardGroup cols={2}>
  <Card title="Set up your Builder profile" icon="user-gear" href="/get-started/marketplace/relevance-builders/setup-builder-profile">
    Learn how to create your Relevance Builder profile and connect your Stripe account for payments
  </Card>
  <Card title="Submit Agents to the Marketplace" icon="upload" href="/get-started/marketplace/relevance-builders/submit-agents">
    Understand our approval process and requirements for submitting Agents and Tools
  </Card>
  <Card title="Get paid for your Agents" icon="dollar-sign" href="/get-started/marketplace/relevance-builders/getting-paid">
    Learn about pricing, payments, and how to maximize your earnings
  </Card>
  <Card title="Support your Agents" icon="life-ring" href="/get-started/marketplace/relevance-builders/supporting-agents">
...
Head to the next page to learn how to [set up your Relevance Builder profile](/get-started/marketplace/relevance-builders/setup-builder-profile) and start submitting to the Marketplace!
