...
In most cases — yes. The Free plan is now BYOK only — customers must bring their own LLM API keys to use agents. For included Actions and Vendor Credits, they'll need to upgrade to Pro or Team.
