...
In most cases — yes. The Free plan is retired, so a new customer needs a Pro or Team subscription to run the Agents they clone.
...
<CardGroup cols={2}>
  <Card title="Share in the Community" icon="users" href="/community">
    Post them in the Community with a demo of the Agent and any help documentation you've created
  </Card>
...
Learn about [supporting your Agents](/get-started/marketplace/relevance-builders/supporting-agents) and engaging with the Relevance AI Community to build trust and increase sales.
