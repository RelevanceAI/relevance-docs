...
- **Which agents do chat role users get access to**: To run specific agents in Chat, users still need Member or higher permissions on those individual assets (agents, tools, knowledge). They won't be able to see any other agents in Chat.
