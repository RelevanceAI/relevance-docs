...
### Giving Organization-Level Permissions

Organization Owners and Admins can assign organization-level roles to users from the organization settings.

<div style={{ width:"100%",position:"relative","padding-top":"56.75%","padding-top":"56.75%" }}>
<iframe src="https://app.supademo.com/embed/[SUPADEMO_ID_ORG_LEVEL]" frameBorder="0" title="Giving Organization-Level Permissions" allow="clipboard-write; fullscreen" webkitAllowFullscreen="true" mozAllowFullscreen="true" allowFullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px" }} />

</div>

### Giving Project-Level Permissions

Project admins can assign project-level roles when inviting users to a project. Organization admins can also set project roles for any project.

<div style={{ width:"100%",position:"relative","padding-top":"56.75%","padding-top":"56.75%" }}>
<iframe src="https://app.supademo.com/embed/[SUPADEMO_ID_PROJECT_LEVEL]" frameBorder="0" title="Giving Project-Level Permissions" allow="clipboard-write; fullscreen" webkitAllowFullscreen="true" mozAllowFullscreen="true" allowFullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px" }} />

</div>

### Giving Asset-Level Permissions

Asset admins can assign roles to specific users for individual assets (Agents, Tools, Knowledge, Workforces).

<div style={{ width:"100%",position:"relative","padding-top":"56.75%","padding-top":"56.75%" }}>
<iframe src="https://app.supademo.com/embed/[SUPADEMO_ID_ASSET_LEVEL]" frameBorder="0" title="Giving Asset-Level Permissions" allow="clipboard-write; fullscreen" webkitAllowFullscreen="true" mozAllowFullscreen="true" allowFullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px" }} />
...
- **Chat-only access**: Users with this role are automatically redirected to Chat and cannot access the web app
- **Asset-level permissions required**: To run specific agents in Chat, users still need Member or higher permissions on those individual assets
- **No asset creation**: Cannot create new agents, tools, or knowledge bases
- **LLM conversations**: Can have conversations with LLMs and in-built Chat Agents directly without agents
- **More powerful than Viewer**: Can trigger Chat and interact with agents (with proper asset permissions)
- **Less powerful than Member**: Cannot create assets or access the web app
