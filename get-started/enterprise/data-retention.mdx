...
<Info>
**Important:** The Data Retention feature controls data stored within Relevance AI's platform. Data retention for our sub-processors is managed in accordance with their respective policies. For further details, please reach out to your account manager.
</Info>

Relevance AI uses various sub-processors to provide our services (such as LLM providers, cloud infrastructure, and integration partners). While the Data Retention feature you configure controls how long data is stored in Relevance AI's systems, each sub-processor maintains their own data retention policies.

**What this means for you:**
- Your configured retention period applies to data stored in Relevance AI
- Sub-processors (like OpenAI, Anthropic, AWS, etc.) follow their own retention policies
- For a complete list of sub-processors, visit [https://trust.relevanceai.com/subprocessors](https://trust.relevanceai.com/subprocessors)
- Contact your account manager for specific questions about sub-processor data retention
...
<AccordionGroup>
  ...
  <Accordion title="Sub-processor data retention" icon="network-wired">
    The Data Retention feature controls data stored in Relevance AI's platform. Sub-processors (such as LLM providers, cloud infrastructure, and integration partners) maintain their own data retention policies.
    
    For a complete understanding of how your data is retained across all systems, contact your account manager to discuss sub-processor retention policies. View our list of sub-processors at [https://trust.relevanceai.com/subprocessors](https://trust.relevanceai.com/subprocessors).
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="How does Data Retention work with sub-processors?">
    The Data Retention feature controls data stored in Relevance AI's platform. Sub-processors (like OpenAI, Anthropic, AWS, etc.) maintain their own data retention policies. For specific questions about sub-processor data retention, contact your account manager. View our list of sub-processors at [https://trust.relevanceai.com/subprocessors](https://trust.relevanceai.com/subprocessors).
  </Accordion>
</AccordionGroup>
