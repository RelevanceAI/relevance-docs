...
<Frame>
  <img 
    src="/images/enterprise/data-retention-settings.png" 
...
<CardGroup cols={2}>
  <Card title="Compliance & Governance" icon="scale-balanced">
    Meet regulatory requirements for data retention limits (GDPR, HIPAA, industry-specific regulations) and demonstrate compliance with data minimization principles
  </Card>
...
<Tabs>
  <Tab title="Compliance Requirements" icon="scale-balanced">
    ...
    **HIPAA (Healthcare)**
    - Helps manage Protected Health Information (PHI) lifecycle
    - Supports minimum necessary standard
    - Aligns with organizational retention policies
