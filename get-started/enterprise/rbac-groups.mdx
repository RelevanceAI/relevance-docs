...
<Warning>
- If your app is assigned to one group, removing the user from that group (or removing the group itself) deprovisions the user.
- **Best practice**: Assign the Relevance app to a single group (e.g., "Relevance App Users") to ensure that removing the user from other groups like "Marketing" does not deprovision the user accidentally.
</Warning>
