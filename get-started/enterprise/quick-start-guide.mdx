...
<Info>
If you don't have these prerequisites, contact your Relevance AI sales representative or [reach out to support](/docs/get-started/support).
</Info>
...
<Steps>
  <Step title="Connect Single Sign-On (SSO)" icon="key">
    ...
    **Time required**: 30-45 minutes
    ...
    [View SSO setup guide →](/docs/get-started/enterprise/sso-setup)
  </Step>
  ...
  <Step title="Enable Directory Sync & Groups" icon="users">
    ...
    **Feature Status**: Directory Sync & RBAC Groups are in Beta with full rollout by **November 20, 2025**. Contact your sales representative to enable this feature.
    ...
    [View Directory Sync setup guide →](/docs/get-started/enterprise/rbac-groups)
  </Step>
  ...
  <Step title="Plan Your Organization & Project Structure" icon="sitemap">
    ...
    **Time required**: 15-30 minutes (planning)
    ...
    [View organization structure best practices →](/docs/get-started/enterprise/org-structure-best-practices)
  </Step>
  ...
  <Step title="Configure Role-Based Access Controls (RBAC)" icon="shield-halved">
    ...
    **Time required**: 30-60 minutes
    ...
    [View RBAC configuration guide →](/docs/get-started/enterprise/rbac)
  </Step>
  ...
  <Step title="Set Usage Limits & Monitoring" icon="gauge-high">
    ...
    **Time required**: 15-20 minutes
    ...
    [View usage limits setup guide →](/docs/get-started/project-management/usage-limits)
  </Step>
  ...
  <Step title="Connect S3 Bucket for Event Streaming (Optional)" icon="database">
    ...
    **Feature Status**: S3 Event Streaming will be fully available by **November 20, 2025**, with self-serve setup by end of year. Contact your sales representative for early access.
    ...
    [View event streaming setup guide →](/docs/get-started/enterprise/streaming-events)
  </Step>
  ...
  <Step title="Configure Integration Controls" icon="plug">
    ...
    **Time required**: 15-20 minutes
    ...
    [View integration controls guide →](/docs/get-started/enterprise/integration-controls)
  </Step>
  ...
  <Step title="Set Up API Key Management (Optional)" icon="code">
    ...
    **Feature Status**: Organization and project-level API keys are gradually being rolled out to Enterprise customers. Contact your sales representative to enable this feature.
    ...
    [View API key management guide →](/docs/get-started/enterprise/org-project-level-api-keys)
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Start Using Chat" icon="messages" href="/docs/chat/intro-to-chat">
    Interact with AI agents through conversational chat
  </Card>
  
  <Card title="Browse the Marketplace" icon="store" href="/docs/get-started/marketplace">
...
<AccordionGroup>
  ...
  <Accordion title="How do I get help during setup?">
    Enterprise customers have access to dedicated support. Contact your sales representative or [reach out to our support team](/docs/get-started/support) via your Slack channel or other support methods. We can also provide setup assistance for complex deployments.
  </Accordion>
