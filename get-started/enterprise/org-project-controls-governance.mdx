...
Enterprises can deactivate users using the WorkOS Dashboard or SCIM API. If a user is marked as deactivated in WorkOS, their accounts and associated API keys will be deactivated immediately. Please see the [SCIM docs for WorkOS](https://workos.com/docs/integrations/scim) for documentation on how to use the PI.