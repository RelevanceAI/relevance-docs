...
<CardGroup cols={4}>
  <Card title="Free" icon="gift">
    **\$0** / month
    ...
    Use the platform with your own API keys.
  </Card>
...
<AccordionGroup>
  <Accordion title="Free — $0 / month">
    ...
    Explore the platform with your own API keys. Build agents, clone from the marketplace, and connect your own LLM.
...
| **[Vendor Credits](/admin/subscriptions/plans) / month**                                     | — (BYOK only)    | 10,000     | 35,000     | Custom     |
...
<Note>
  Top-ups are only available on paid plans — Free users need to upgrade to Pro or Team to purchase. See [Plans and credits](/admin/subscriptions/plans) for the in-platform purchase flow.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="What can I do on the Free plan?">
    The Free plan is BYOK only — you bring your own LLM API keys to use AI features. There are no included Actions or Vendor Credits on Free. To get included Actions and Vendor Credits without providing your own API keys, upgrade to Pro (the entry-level paid tier) or Team.
  </Accordion>
  ...
  <Accordion title="Do I need to enter a credit card to try Relevance AI?">
    No, signing up for the Free plan doesn't require a credit card. The Free plan is BYOK only — you'll need to provide your own LLM API keys to use AI features. Paid plans (Pro and above) include Actions and Vendor Credits.
  </Accordion>
