...
![tool page](/images/build-custom-tools/tool1.png)
...
More details documentation is available at [Templates](/templates/introduction) and [Create Tool](/build-custom-tools/create-a-tool).
