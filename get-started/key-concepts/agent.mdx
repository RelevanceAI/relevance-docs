...
Using GPT or any of the prebuilt LLMs, you are limitted to the knowledge and capabilities of the LLM. 
Take a further step with Agent on Relevance. 
You can now empower the LLM behind the Agent with your favourite, most useful and relevant chains. 
Note that you are not limitted to Relevance chains. 
