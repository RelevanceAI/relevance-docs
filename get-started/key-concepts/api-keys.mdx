...
<div style={{ width:"100%",position:"relative",paddingTop:"65%" }}>
<iframe src="https://app.supademo.com/embed/cmbg69nup4eyssn1rt129znrs?embed_v=2" frameBorder="0" title="Create a Relevance API key" allow="clipboard-write" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px",objectFit:"cover" }} />
</div>
...
<iframe src="https://app.supademo.com/embed/cmbg0620b4azssn1r2pkbsbvl?embed_v=2" frameBorder="0" title="Create a custom API key" allow="clipboard-write" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px",objectFit:"cover" }} />
</div>
