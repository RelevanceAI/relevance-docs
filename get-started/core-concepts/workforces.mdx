...
<CardGroup cols={2}>
  ...
  <Card title="Automated quality testing" icon="flask-vial">
    Use Evals to test multi-agent workflows end-to-end and verify agent handoffs work correctly.
  </Card>
</CardGroup>
...
7. **Use Evals for quality assurance**: Set up [evaluation rules](/build/agents/build-your-agent/evals) to automatically test your workforce's end-to-end performance and verify agent handoffs preserve context correctly.
...
<AccordionGroup>
  ...
  <Accordion title="Can I test my Workforce automatically?">
    Yes. Use [Evals](/build/agents/build-your-agent/evals) to create automated tests for your workforce. You can verify agent handoffs, test end-to-end workflows, and monitor quality over time.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={3}>
  <Card
    ...
    href="/build/workforces/create-a-workforce"
  >
