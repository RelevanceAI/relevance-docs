  ...
  <Tab title="Evaluate & improve">
    ...
    **Example prompts:**
    ...
    <AccordionGroup>
      ...
      <Accordion title="Evaluate a workforce">
        *"Set up an eval test set on my 'Customer Triage' workforce, run it against three scenarios I describe, and tell me which scenarios failed and why."* Workforce evals are currently API-only and drive end-to-end through the MCP.
      </Accordion>
    </AccordionGroup>
  </Tab>
