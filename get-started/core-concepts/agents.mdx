...
The agent list includes filters to help you find specific agents based on your relationship to them:
...
- **All agents** — shows every agent you have access to in the project.
...
Your column width settings are saved automatically and persist across page reloads.
