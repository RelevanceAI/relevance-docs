...
Tags let you categorize agents with flexible, cross-cutting labels — unlike folders, an agent can have multiple tags at once. To add a tag to an agent, open the agent and select tags from the tag selector. You need Editor permission to create or manage tags.
