...
4. **Use enrichment**: Run [tools](/build/knowledge/enrich-with-tool) over your knowledge to add summaries, tags, or derived fields that help agents find the right content faster.
5. **Use snippets for quick access**: Set up [snippets](/build/knowledge/use-snippets-for-quick-access) for frequently referenced information your agents use often.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="plug"
    href="/build/knowledge/integrated-knowledge-sources/google-drive"
  >
