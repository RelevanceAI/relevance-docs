...
While testing, you have full control over execution. If you need to stop the agent mid-run — maybe you spotted an issue or want to adjust something — click the red stop button that appears while the agent is working. Your next message will resume the agent from where it stopped. This gives you precise control when refining your agent's behavior.
