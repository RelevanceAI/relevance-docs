...
Inventor also supports a [voice interview mode](/build/agents/create-an-agent#voice-interview-mode) — click **Talk to Inventor** to describe your agent in a live voice conversation instead of typing.
