...
7. Click **Publish** and confirm in the dialog — your agent isn't live until you publish
...
Every change to your agent — prompt edits, tool updates, configuration — saves as a draft. Drafts don't affect users until you publish.
...
Tests inside the agent builder always run against the draft version, so you can verify your changes first. See [Draft and publish](/build/agents/publish-your-agent) for more detail on version history and per-tool editing.
