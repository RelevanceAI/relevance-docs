...
If you see a **Talk to Inventor** button in the Inventor panel, you can describe what to build by speaking instead of typing — this is [voice interview mode](/build/invent/invent#voice-interview-mode), an experimental feature available to select users.
...
Prefer to work from your terminal? Connect your AI coding environment — Claude Code, Cursor, or any MCP-compatible client — to Relevance AI over MCP. Describe what you want in natural language and your AI assistant builds and edits your Agents, Tools, and Workforces directly. See [MCP & Plugins](/get-started/core-concepts/mcp-plugins) to get started.
