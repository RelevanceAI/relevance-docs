...
<Tip>
If you have access to Inventor v3 (behind the `InventV3` feature flag), you can make refinements using natural language instead of navigating through settings. Just describe what you want to change in the Inventor v3 sidebar, and it will update your Agent configuration for you.
</Tip>
