...
<CardGroup cols={2}>
    <Card title="Get started" icon="circle-play" href="/get-started/quickstart/templates">
        Build AI apps in under 5 mins
    </Card>
    <Card title="Get started" icon="circle-play" href="/get-started/quickstart/agent">
