...
![The Relevance AI platform](/images/platform-dashboard.png)
...
<CardGroup cols={2}>
  <Card
    title="Agents"
    icon="robot"
    href="/get-started/core-concepts/agents"
  >
  ...
  <Card
    title="Workforces"
    icon="users-gear"
    href="/get-started/core-concepts/workforces"
  >
  ...
  <Card
    title="Knowledge"
    icon="brain"
    href="/build/knowledge/create-knowledge"
  >
  ...
  <Card
    ...
    href="/get-started/core-concepts/tools"
  >
