...
<Steps>
  ...
  <Step title="From the organization switcher">
    The region code is also visible in the organization switcher in the Relevance AI interface.
    
    <Frame caption="Your organization's region code appears in the URL and organization switcher, and determines where your data is stored">
      <img src="/images/placeholder-org-region.png" alt="Organization switcher showing region code" />
    </Frame>
    
    <Note>Screenshot placeholder - actual image to be added by Alex</Note>
  </Step>
</Steps>
...
<Warning>
  **Region cannot be changed after creation**
  ...
  If you need to change your organization's region, you must contact support. This cannot be done through the UI. Changing regions requires creating a new organization in the desired region.
</Warning>
