...
3. Follow the sign-up wizard, which includes choosing the [region you want to store you data](https://relevanceai.com/docs/security#regions) in.
   ...
   <Warning>Your region choice is permanent and cannot be changed after your organization is created. If you need to change regions, [contact support](/support) to discuss your options. Learn more about [organization regions](/get-started/project-management/ids#organization-region).</Warning>
