...
3. Follow the sign-up wizard, which includes choosing the [region you want to store you data](https://relevanceai.com/docs/security#regions) in.
   ...
   <Warning>Your region choice is **permanent** and cannot be changed after your organization is created. Choose carefully based on your data residency requirements. Learn more about [organization regions](/get-started/project-management/ids#organization-region).</Warning>
