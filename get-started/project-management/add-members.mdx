...
If you're already a member of the same organization as the project, you may be automatically added to the project without receiving an email invitation. In this case, you can access the project immediately using the [project switcher](/get-started/project-management/switch-projects).
