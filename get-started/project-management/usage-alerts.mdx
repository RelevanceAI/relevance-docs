...
<Info>
  Usage Alerts are separate to Usage Limits, which hard stops usage when you reach a specified limit. You can learn more about Usage Limits [here](/get-started/project-management/usage-limits).

  Looking for automatic top-ups instead of just notifications? Check out [Spend Controls](/get-started/subscriptions/spend-controls).
</Info>
