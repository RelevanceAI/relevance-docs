---
title: "Credit and action usage limits"
description: "Set usage limits to make sure your users don't exceed hard limits"
---

<Info>Usage Limits are separate to Usage Alerts, which only send email notifications when your usage reaches a specified limit. You can learn more about Usage Alerts [here](/get-started/project-management/usage-alerts).</Info>
...
<iframe src="https://app.supademo.com/embed/cmg8z6pjv25d02nomsp64t35a" frameBorder="0" title="Set usage limits at the organization level" allow="clipboard-write" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px" }} />
</div>
...
<div style={{ width:"100%",position:"relative","padding-top":"56.75%"}}>
<iframe src="https://app.supademo.com/embed/cmg8z6pjv25d02nomsp64t35a" frameBorder="0" title="Set usage limits at the project level" allow="clipboard-write" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px" }} />
</div>
