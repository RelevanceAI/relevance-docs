...
However, to take Sean to the next level, we need to give him some Tools to be able to achieve his goals - just like us,
...
<Tip>
  ...
  experts. Domain expert have the knowledge to design Tools that are best
...
For example, with Sean we have Tools for enriching leads with LinkedIn, google search and web browsing to begin. Start with these and toggle
the ones you would give permission for auto-run (i.e. if the toggle is off, Sean will ask for permission to run the Tool each time it is needed).
