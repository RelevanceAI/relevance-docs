...
2. Click the **Ask for Help** button, found in the bottom left corner of the Dashboard page.
3. In the CMD + K Chat popup, click on **Create a Support Ticket** to talk to send a message to our support team, or ask our AI Agent in the chat dialog box.

<div style={{ width:"100%",position:"relative",paddingTop:"56.25%" }}>
<iframe src="https://app.supademo.com/embed/cmfd6exqr8eca39ozcqgtdp8x?v_email=EMAIL&embed_v=2&utm_source=embed" frameBorder="0" title="Invite a user to a project in Relevance AI" allow="clipboard-write" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px" }} />
</div>
