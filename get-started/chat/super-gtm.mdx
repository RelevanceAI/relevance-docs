...
Super GTM includes a filesystem explorer that shows which files your agent has access to during a conversation. As the agent works, the file tree displays visual indicators so you can see at a glance which files it has interacted with — without reviewing individual tool call logs.
