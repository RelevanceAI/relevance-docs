...
Chat provides multiple ways to work with files in your conversations. You can upload files directly to provide context, and when viewing files in the file viewer panel, you can quickly attach them to your messages for more targeted AI responses.

### File Viewer Panel

When you upload files to Chat or when Agents generate files as outputs, you can view them in the file viewer side panel. This panel opens on the right side of your Chat interface and displays the contents of documents, images, spreadsheets, and other supported file types.

The file viewer panel allows you to:
- Preview file contents without downloading
- Review files generated by Agents
- Examine uploaded documents in detail

### Attaching Files from the Viewer

When the file viewer panel is open, a pill button appears in your chat input field. This button allows you to attach the currently-open file as context to your next message.

**To attach a file from the viewer:**

1. Open a file in the file viewer panel by clicking on it
2. Look for the pill button that appears in the chat input field
3. Click the pill button to attach the file as context
4. Type your message and send

This feature is useful when you want to:
- Ask specific questions about a file you're currently viewing
- Request modifications to a document without re-uploading it
- Reference a file generated by an Agent in a follow-up message
- Get more targeted AI responses about specific files

<Info>
The pill button only appears when a file is open in the viewer panel. If you don't see it, make sure you have a file open in the side panel.
</Info>

<Note>
For information about file type specifications and size limits, see the [Supported file types in Chat](#supported-file-types-in-chat) section below.
</Note>
