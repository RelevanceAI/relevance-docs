...
When you type @ in the chat input, you'll see a list of all available agents and workforces in your project. To help you choose the right one, hover over any item in the list to see a preview card with helpful details:

**For agents, the preview card shows:**
- Agent name
- Agent description
- Tool icons with tooltips showing what tools the agent uses

**For workforces, the preview card shows:**
- Workforce name
- Workforce description
- Member agent icons showing which agents are part of the workforce

This preview makes it easy to understand what an agent or workforce does before you select it, helping you pick the right tool for your task.
