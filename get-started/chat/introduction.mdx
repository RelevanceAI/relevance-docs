...
<Card title="Edit Agent Skills in Chat" icon="pen-to-square" href="/get-started/chat/edit-agent-skills">
  Learn how to edit agent prompts and skills from the Chat interface
</Card>

The Chat editor provides the same visual editing experience as the main Agent Builder, with tool and action references appearing as visual pills with icons and readable names.
