...
<Info>
Conversation tagging is a GTM-mode feature available to users with GTM mode enabled.
</Info>

Keep your Chat conversations organized with custom colored tags. Tag conversations by topic, priority, status, or any criteria that matters to your workflow, then filter by tags in the sidebar or search modal to quickly find what you need.

<CardGroup cols={2}>
  <Card title="Custom tags" icon="tag">
    Project admins create tag definitions with custom names and colors
  </Card>
  <Card title="Easy filtering" icon="filter">
    Filter conversations by tag in the sidebar and search modal
  </Card>
</CardGroup>

<Card title="Learn about conversation tagging" icon="arrow-right" href="/get-started/chat/conversation-tagging">
  See how to create tags, apply them to conversations, and filter your chat history
</Card>
