...
The Chat file browser lets you organize uploaded files into folders, making it easier to manage your conversation context and keep related files together.

### Organizing files with folders

You can create folders in the Chat file browser to group related files. This is useful when working with multiple documents across different topics or projects within the same conversation.

### Moving folders

You can move entire folders within the Chat file browser using drag and drop:

1. Click and hold on the folder you want to move
2. Drag the folder to its new location in the file browser
3. Release to drop the folder in place

When you move a folder, all files and subfolders inside it automatically move with it. This makes it easy to reorganize your file structure without having to move items individually.

<Tip>
Use folders to organize files by topic, project, or document type. This keeps your Chat workspace organized, especially when working with many files across multiple conversations.
</Tip>
