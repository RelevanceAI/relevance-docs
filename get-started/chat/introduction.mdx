...
When no conversation is active, the desktop app displays up to 5 recent meeting chat links on the home view. These links appear after meetings end, giving you quick access to the chat conversation from each meeting.

Each link shows:

- A platform-specific icon (Google Meet, Zoom, Teams, etc.)
- The meeting title
- A timestamp

Click any link to open that meeting's chat conversation directly. Links persist between sessions, so they remain available the next time you open the desktop app.
