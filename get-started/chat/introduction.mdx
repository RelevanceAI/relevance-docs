...
<CardGroup cols={2}>
  <Card title="Web & Mobile" icon="browser" href="https://chat.relevanceai.com">
    Use Chat in your browser on desktop or mobile devices
  </Card>
  <Card title="Desktop App" icon="desktop" href="/get-started/desktop-app/introduction">
    Record meetings locally on your Mac and chat with transcripts
  </Card>
</CardGroup>

<Tip>
The [macOS Desktop App](/get-started/desktop-app/introduction) is perfect for recording meetings on your device. It automatically detects meetings, captures audio, transcribes in real-time, and syncs to your account where you can interact with the content using Chat.
</Tip>
