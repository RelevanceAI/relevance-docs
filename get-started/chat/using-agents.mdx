...
| Website Builder | Build websites from a prompt or description | 100+ credits per run |
| Image Generator | Generate images from text prompts | 10+ credits per run |
| Deep Researcher | Conduct comprehensive research on a topic | 100+ credits per run |
