...
2. **Plan your Content and Slide Design**: Look at [Generate Content and Designing Slides](/get-started/chat/chat-agents/slide-builder#generating-content-and-designing-slides) for tips.
...
<Tabs>
  <Tab title="Slide Builder Introduction">
  ...
  <Tab title="BrandKits and Templates">
    <Frame caption="Learn how to create and use BrandKits and Templates in Slide Builder.">
      <iframe
        className="w-full aspect-video rounded-xl"
        src="https://www.youtube.com/embed/OtE4j5dFYxY"
        title="BrandKits and Templates in Slide Builder"
        allowFullScreen
      ></iframe>
    </Frame>
  </Tab>
...
<CardGroup cols={2}>
  ...
  <Card title="Build Your Own Agent" icon="robot" href="/build/agents/create-an-agent">
    Create a custom agent and use it in Chat
  </Card>
</CardGroup>
