...
The agent already knows how to create, refine, and consolidate skills through its built-in Skill Creator. These tips are for when you want to fine-tune a skill's behavior yourself.
