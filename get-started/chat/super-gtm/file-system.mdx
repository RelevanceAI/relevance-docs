...
<Tabs>
  ...
  <Tab title="Session files">
    ...
    You generally don't need to interact with session files directly. The agent manages them as part of its workflow. Session files will also persist across sessions, discoverable in a folder matching the conversation id.
  </Tab>
</Tabs>
