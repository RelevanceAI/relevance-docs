...
<AccordionGroup>
  ...
  <Accordion title="Gong">
    ...
    **How to connect:**
    1. In the Super GTM settings panel, find **Gong** under Integrations
    2. Click **Add Integration**
    3. Sign into your Gong account in the pop-up window and authorize the requested permissions

    **Things to know:**
    - Gong API access typically requires Technical Admin permissions in Gong — check with your Gong admin if authorization fails
    - The agent can only access calls that are already processed and indexed in Gong
    - For full documentation on available Gong tool steps, see the [Gong integration page](/integrations/popular-integrations/gong)
  </Accordion>
