---
title: "Integrations"
description: "Connect your GTM tools to Super GTM via OAuth, API key, or use built-in integrations that work automatically"
---
...
<Tabs>
  ...
  <Tab title="Built-in">
    Some integrations work automatically with no credentials required — they're always available to the Super Agent.
  </Tab>
</Tabs>
...
<CardGroup cols={3}>
  <Card title="Connected and enabled" icon="circle-check">
    Integration is active and the Super Agent can use it
  </Card>
...
<Tabs>
  <Tab title="Ask before writing (default)">
    The Super Agent pauses and asks for your approval before writing to any integration — e.g. "I'm about to create a contact in HubSpot — approve?"
  </Tab>
  <Tab title="Never ask">
    The Super Agent executes writes automatically without asking for confirmation.
  </Tab>
...
<CardGroup cols={3}>
  <Card title="HubSpot" icon="chart-simple">
    CRM read/write — OAuth
  </Card>
  <Card title="Salesforce" icon="cloud">
    CRM read/write, SOQL queries — OAuth
  </Card>
  <Card title="Apollo" icon="rocket">
    Contact enrichment, prospecting — API key
  </Card>
  <Card title="Gong" icon="microphone">
    Call recordings and transcripts — API key
  </Card>
  <Card title="Salesloft" icon="bullhorn">
    Sales engagement — API key
  </Card>
  <Card title="Slack" icon="hashtag">
    Messages, channels, search — OAuth
  </Card>
  <Card title="Gmail" icon="envelope">
    Read, send, draft emails — OAuth
  </Card>
  <Card title="Microsoft Outlook" icon="envelope-open">
    Read, send, draft emails — OAuth
  </Card>
  <Card title="Microsoft Teams" icon="comments">
    Chat, channels, meeting transcripts — OAuth
  </Card>
  <Card title="Google Calendar" icon="calendar">
    Events and availability — OAuth
  </Card>
  <Card title="Microsoft Calendar" icon="calendar-days">
    Events and shared calendars — OAuth
  </Card>
  <Card title="Google Docs" icon="file-lines">
    Read and edit documents — OAuth
  </Card>
  <Card title="Google Drive" icon="hard-drive">
    File storage read/write — OAuth
  </Card>
  <Card title="Google Sheets" icon="table">
    Spreadsheet read/write — OAuth
  </Card>
  <Card title="Notion" icon="book">
    Pages, databases, search — OAuth
  </Card>
  <Card title="Linear" icon="list-check">
    Issues, projects, comments — OAuth or API key
  </Card>
  <Card title="Ashby" icon="user-tie">
    Recruiting and ATS — API key
  </Card>
  <Card title="Avoma" icon="video">
    Meeting intelligence — API key
  </Card>
  <Card title="Firmable" icon="building">
    Company data enrichment — API key
  </Card>
  <Card title="ZoomInfo" icon="database">
    Contact and company intelligence — API key (3 fields)
  </Card>
  <Card title="Cursor" icon="terminal">
    Agent control and conversations — API key
  </Card>
</CardGroup>

Built-in integrations that need no setup:
...
<CardGroup cols={4}>
  ...
  <Card title="Native Meetings" icon="phone">
    Uses your connected calendar
  </Card>
</CardGroup>

### Quick reference

| OAuth | API key | Either | Built-in |
| --- | --- | --- | --- |
| HubSpot | Apollo | Linear | Filesystem |
| Salesforce | Gong | | Python |
| Gmail | Salesloft | | Skills |
| Google Calendar | Ashby | | Native Meetings |
| Google Docs | Avoma | | |
| Google Drive | Cursor | | |
| Google Sheets | Firmable | | |
| Notion | ZoomInfo (3 fields) | | |
| Slack | | | |
| Microsoft Outlook | | | |
| Microsoft Teams | | | |
| Microsoft Calendar | | | |
...
<AccordionGroup>
  ...
  <Accordion title="ZoomInfo">
    **Connection method:** API key (3 fields)

    Connects Super GTM to ZoomInfo for contact and company intelligence. Unlike other API key integrations, ZoomInfo requires three separate credentials.
