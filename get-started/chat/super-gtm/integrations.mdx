...
<AccordionGroup>
  ...
  <Accordion title="Google Calendar">
    ...
    **Things to know:**
    ...
    - Once connected, your Google Calendar events appear in the [meetings widget](/get-started/chat/super-gtm/introduction#meetings-widget) in the Super GTM interface
  </Accordion>
  ...
  <Accordion title="Microsoft Calendar">
    ...
    **Things to know:**
    ...
    - Once connected, your Microsoft Calendar events (including Teams meetings) appear in the [meetings widget](/get-started/chat/super-gtm/introduction#meetings-widget) in the Super GTM interface
  </Accordion>
