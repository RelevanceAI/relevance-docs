...
<AccordionGroup>
  ...
  <Accordion title="Salesforce">
    ...
    **Credentials:** OAuth. Before connecting, check **Sandbox account** if you're connecting a Salesforce sandbox (test/staging) environment — this routes login to test.salesforce.com instead of login.salesforce.com. Leave unchecked for production accounts.
  ...
  <Accordion title="Linear">
    ...
    **Credentials:** OAuth (no extra fields) or a single API key
  ...
  <Accordion title="ZoomInfo">
    ...
    **Credentials:** Three fields — Email, Client ID, and Private Key
...
| Integration | Method | Credentials |
| --- | --- | --- |
| HubSpot | OAuth | — |
| Salesforce | OAuth | Sandbox toggle |
| Gmail | OAuth (GSuite) | — |
| Google Calendar | OAuth (GSuite) | — |
| Google Docs | OAuth (GSuite) | — |
| Google Drive | OAuth (GSuite) | — |
| Google Sheets | OAuth (GSuite) | — |
| Notion | OAuth | — |
| Slack | OAuth | — |
| Microsoft Outlook | OAuth | — |
| Microsoft Teams | OAuth | — |
| Microsoft Calendar | OAuth | — |
| Linear | OAuth or API key | OAuth (no extra fields) or single API key |
| Apollo | API key | Single key |
| Gong | API key | Single key |
| Salesloft | API key | Single key |
| Ashby | API key | Single key |
| Avoma | API key | Single key |
| Cursor | API key | Single key |
| Firmable | API key | Single key |
| ZoomInfo | API key | Email, Client ID, Private Key |
