...
<CardGroup cols={2}>
  ...
  <Card title="Outline preview" icon="list-check">
  ...
  <Card title="Content customization" icon="file-lines">
  ...
  <Card title="Branding and design customization" icon="palette">
    Your slides can look and feel exactly like your brand.
  </Card>
  <Card title="Export and reuse" icon="file-export">
...
<iframe src="https://app.supademo.com/embed/cmha5hvas0mzc6kif0twz83bs" frameBorder="0" title="Getting started with Slide Builder" allow="clipboard-write; fullscreen" webkitAllowFullscreen="true" mozAllowFullscreen="true" allowFullscreen style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', border: '3px solid #5E43CE', borderRadius: '10px' }} />
</div>
...
<Steps>
  <Step title="Generate content using prompts">
  ...
  <Step title="Incremental building">
...
<CardGroup cols={2}>
  ...
  <Card title="AI design guidelines" icon="sliders">
...
<div style={{ width: '100%', position: 'relative', paddingTop: '56.25%' }}>
<iframe src="https://app.supademo.com/embed/cmi3vc0s60rg1b7b4uwv31m8d" frameBorder="0" title="How to export slides" allow="clipboard-write; fullscreen" webkitAllowFullscreen="true" mozAllowFullscreen="true" allowFullscreen style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', border: '3px solid #5E43CE', borderRadius: '10px' }} />
</div>
