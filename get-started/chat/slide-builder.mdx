...
<CardGroup cols={2}>
  ...
  <Card title="Agent integration" icon="robot">
    Work with your Relevance AI agents to research or generate content.
  </Card>
...
<Steps>
  <Step title="Generate content using prompts">
    Tell Slide Builder what content you want on your slide deck. Alternatively, use `@` to integrate your Relevance AI agent.
  </Step>
  ...
  <Step title="Branding and design customization using Brand Kit">
