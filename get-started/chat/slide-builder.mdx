...
- **Export and reuse**: Export your slides in multiple formats including PDF, Images, PPTX, and JSON to re-use them in a new chat or share with others.
...
2. **Plan your content and slide design**: Look at [Generating content and designing slides](/get-started/chat/slide-builder#generating-content-and-designing-slides) for tips.
