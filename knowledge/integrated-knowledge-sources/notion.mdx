...
You can select specific Notion pages for your Agent to read as Knowledge sources.
...
<AccordionGroup>
  <Accordion title="Are Notion databases supported?">
    We're in the process of adding support for Notion databases - watch this space!
  </Accordion>
