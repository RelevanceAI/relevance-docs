...
2. Click **+ New Knowledge** and choose how you want to add data:
   - **Upload files** — CSV, PDF, Excel, JSON, or audio
   - **Enter manually** — start with an empty table and add data directly
   - **Extract from websites** — pull content from URLs
   - **Connect integrations** — sync from [Google Drive](/knowledge/integrated-knowledge-sources/google-drive), [SharePoint](/knowledge/integrated-knowledge-sources/sharepoint), or [Notion](/knowledge/integrated-knowledge-sources/notion)
3. Go to your agent's settings and connect the knowledge base
4. Test your agent to make sure it's pulling the right information
