...
<Columns cols={2}>
  ...
  <Card title="Sharepoint" href="/knowledge/integrated-knowledge-sources/sharepoint" icon="microsoft">Use Sharepoint as a source of Knowledge for your Agents</Card>
</Columns>
