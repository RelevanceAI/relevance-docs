...
Click on `Blank` and name your table. 
...
## Download
You can export your data and the analysis results in [standard format](/tool/export) (i.e. as seen in the table)
or wide format (YADA YADA) (i.e. flattened categorical fields).
