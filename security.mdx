...
- You can request account deletion, and we'll process it within 30 days
...
For Enterprise customers, Relevance AI offers advanced [Data Retention](/get-started/enterprise/data-retention) capabilities that allow organizations to automatically manage the lifecycle of sensitive data. This Enterprise feature enables you to:

- Configure automatic deletion policies for tool runs, agent conversations, workforce tasks, and asset versions
- Set organization-wide retention periods to meet compliance requirements
- Support regulatory frameworks like GDPR, HIPAA, and industry-specific regulations
- Reduce security risks by automatically removing old, sensitive data
- Optimize storage costs and platform performance

<Info>
Data Retention is an Enterprise feature that must be enabled by the Relevance AI team. [Learn more about Data Retention →](/get-started/enterprise/data-retention)
</Info>
