...
### Purchases are project-specific

When you purchase a listing, it's tied to the specific project where you made the purchase. If you purchase a listing on one project, you won't see it in My Purchases on another project.

### Cross-project cloning

Whether you can clone a purchased listing to another project depends on the Relevance Builder's settings. Most Builders restrict cross-project cloning for paid listings to ensure proper licensing per project.

### What appears in My Purchases

The My Purchases page only displays paid listings you've purchased. Free listings don't appear here, as they can be easily cloned again directly from the Marketplace at any time.
