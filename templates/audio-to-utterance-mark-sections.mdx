...
Go to [Data](/get-started/key-concepts/data) and refresh the page. 
You can explore the transcribed text, review the marked utterances and [export](/templates/export#export-to-csv) the table content into 
a CSV file.
