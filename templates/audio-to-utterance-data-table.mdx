...
5. **Organized Results**:
The Tool provides the results as a data table saved on your account. This table is accessible under the [Data](/get-started/key-concepts/data) page. 
Columns are
    * text: utterances
...
Go to [Data](/get-started/key-concepts/data) and refresh the page. You can explore the transcribed text, review the 
extracted utterances and [export](/templates/export#export-to-csv) the table content into a CSV file.
...
2. Use the resulting table as [knowledge](/build-custom-tools/knowledge/knowledge) in a Tool similar to 
