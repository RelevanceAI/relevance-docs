...
* checking all the received suggestions 
* finalizing the category list using your domain knowledge and the goals for categirization
* use the finalized list in the [Text categorizer/Classifier](/templates/text-categorizer-classifier.mdx) Tool.
