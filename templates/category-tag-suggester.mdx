...
---
One of the frequently used templates at Relevance is "Extract categories in data".
...
![Extract categories in data](/images/templates/category-tag-suggester/category-tag-suggester-form.png)
