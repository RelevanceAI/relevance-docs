...
![GPT on my Files](/images/templates/gpt-on-my-files/GPT-on-my-files.png)
...
### Tool steps
![LLM](/images/templates/gpt-on-my-files/GPT-on-my-files-answer-build-llm.png)
1. **LLM**: [A large language model component](/custom-tools/tool-steps/llm) is all set up to provide you access to GPT. 
In the prompt section, you will provide the required information
