...
Tool or automatically generated from Tools such as [Audio to utterance data table](/templates/audio-to-utterance-data-table). 
By customizing the knowledge set, you can ensure that the Tool is not limited to one or a restricted set of interviews. Simply change the 
data and the themes and apply the Tool to any qual data.
