...
With advanced customization, magical deployment and multi-provider support, Relevance AI makes it easy to integrate large language models into your workflows to create powerful automations. Built for low-code users to change the world.
...
<CardGroup cols={2}>
    ...
    <Card
        ...
        icon="book"
        href="/sdk/reference/transformation-steps"
    >
