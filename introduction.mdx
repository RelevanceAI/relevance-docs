...
With advanced customization and multi-provider support, Relevance AI makes it easy to integrate large language models like GPT or Cohere into your applications.
...
<Card
    ...
    icon="book"
    href="/reference/tranformation-steps"
>
...
Check out how easy it is to builda and deploy a PDF Q&A application, in less than 2 minutes.
