...
<Tab title="No build" id="no-build">
  ...
  Upload your CS playbooks, segmentation rules, renewal motion docs, and product positioning. Every conversation references them — sharper output, no new setup.
