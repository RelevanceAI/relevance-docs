...
[Build a competitive intel Agent](/build/introduction) and open it in chat. A rep asks during a deal where a competitor surfaces.
...
Codify the patterns into the Agent so the same signals surface every time:

- Refine the [prompt](/build/agents/build-your-agent/prompt) to track your top 5–10 competitors and define what counts as a signal vs noise
