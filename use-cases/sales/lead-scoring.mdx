...
Codify your qualification framework into the Agent so every score reflects your team's lens:

- Upload your ICP, persona definitions, and disqualification rules to [Knowledge](/build/knowledge/create-knowledge)
- Refine the [prompt](/build/agents/build-your-agent/prompt) to produce consistent fit and intent scores plus the reasoning behind each one
