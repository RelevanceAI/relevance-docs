...
Shape the Agent so every brief lands in the same format your reps already trust:

- Define the brief format in the [prompt](/build/agents/build-your-agent/prompt) — length, sections, tone
