...
The Marketplace ships pre-built Agents you can clone in one click. Adapt them to your CRM, your segmentation, your pipeline definitions.
...
<CardGroup cols={3}>
  <Card title="Lead Enricher" icon="database" href="https://marketplace.relevanceai.com/listing/88ab63e7-f357-48ad-84c6-463be16d850b">
    Fill in firmographics and contact details on every record — the foundation for everything else RevOps does.
  </Card>
  <Card title="Sales Researcher" icon="magnifying-glass" href="https://marketplace.relevanceai.com/listing/4b454347-0656-4fee-9c15-8fb2f2713424">
    Deep account research for pipeline review prep and territory planning.
  </Card>
...
Click **Clone to my workspace** on any listing, connect your CRM and data sources, and run on real records.
...
<Tab title="No build" id="no-build">
  ...
  Upload your ICP definitions, segmentation rules, routing logic, and pipeline definitions. Every conversation references them — same chat, sharper output.
  ...
  When chat and templates stop being enough — when you want the Agent to enforce your routing rules across the whole pipeline and orchestrate cross-system workflows — pick the **Build visually** tab above.
</Tab>
...
<Tab title="Build visually" id="build-visually">
  ...
  - **Data sources** — [Apollo](/integrations/popular-integrations/apollo), ZoomInfo, web search for enrichment
...
<Tab title="Build with AI" id="build-with-ai">
  ...
  - **Custom Python and JS code blocks** live inside Tools. Parse a custom dedup heuristic, apply business logic to routing edge cases, transform pipeline data — drop a code block in and write the logic directly.
  - **The JS SDK** lets you call Agents and Tools from your own Node.js app. Useful when wiring up a CDP webhook, embedding into a custom RevOps dashboard, or integrating with your data warehouse pipeline.
</Tab>
</Tabs>
</div>
...
<CardGroup cols={2}>
  ...
  <Card title="L4 — Self-driving" icon="infinity">
    "Improve forecast accuracy by 20%" — the Agent learns which deal signals actually predicted close vs. slip, weighs them, and surfaces a sharpening forecast over time.
  </Card>
</CardGroup>
