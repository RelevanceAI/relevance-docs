...
See the full guide at [Adding condition](/tool/tool-steps) to a step.
...
See the full guide at [Loop through a step](/tool/tool-steps#run-a-step-multiple-times-in-a-loop).
