...
Instead of deleting a tool, consider these alternatives:

- **Remove from specific agents**: Go to the Agent Builder → Tools section and remove the tool from individual agents without deleting it from your project
- **Create a new version**: Clone the tool, make your changes, and keep the original as a backup
- **Archive or rename**: Add "[ARCHIVED]" or "[OLD]" to the tool name to indicate it's no longer active
- **Disable sharing**: Remove shared links without deleting the tool itself
