...
<Note>
While Python code steps can use OAuth authentication through the Integration helper class, they do not support User Level Authentication (Dynamic Auth). If you need individual users to authenticate with their own accounts, you should use dedicated OAuth-based tool steps instead of Python code.
</Note>
