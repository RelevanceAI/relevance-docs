...
description: "The Advanced knowledge search (2m context) tool allows you to search your knowledge table by using a prompt"
---

## Add the 'Advanced Knowledge Search (2m) Tool step to your Tool

<div style={{ width:"100%",position:"relative",paddingTop:"75%" }}>
<iframe src="https://app.supademo.com/embed/cmcwogmal1l5n9emp09x9eqv7" frameBorder="0" title="Add the Insert Knowledge Tool step to your Tool" allow="clipboard-write" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px",objectFit:"cover" }} />
