...
<div style={{ width:"100%",position:"relative","padding-top":"56.75%",paddingTop:"55%" }}>
<iframe src="https://app.supademo.com/embed/cmcycpn2u1bqnc4kjevlw5uy6" frameBorder="0" title="Add the Advanced Knowledge Search tool step to your Tool" allow="clipboard-write; fullscreen" webkitAllowFullscreen="true" mozAllowFullscreen="true" allowFullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px",objectFit:"cover" }} />
...
<AccordionGroup>
    <Accordion title="What is the difference between Advanced Knowledge Search and Knowledge Search?">
        - [Knowledge Search](/tool/tool-steps/knowledge/knowledge-search) is easier to use out of the box, with sensible default options that work well for most use cases.
