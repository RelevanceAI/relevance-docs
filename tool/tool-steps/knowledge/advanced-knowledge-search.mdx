...
<AccordionGroup>
    <Accordion title="What is the difference between Advanced Knowledge Search and [Advanced Knowledge Search (2m context)](/tool/tool-steps/knowledge/advanced-knowledge-search-2m)?">Advanced Knowledge Search (2m) allows you to search your entire knowledge set with just a prompt whilst Advanced Knowledge Search allows you to filter down your search results for a more focused retrieval.</Accordion>
