...
<AccordionGroup>
    <Accordion title="What is the difference between Knowledge Search and Advanced Knowledge Search?">
        ...
        -   [Advanced Knowledge Search](/tool/tool-steps/knowledge/advanced-knowledge-search) gives you greater control and fine-tuning capabilities for more precise retrieval — but may be slower in comparison. 
    </Accordion>
