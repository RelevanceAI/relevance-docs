...
to access the url in the first search results ([FAQ](/tool/faq#error-url-issue)).
...
step make sure, you access the URL field. Read more at [URL must be a string](/tool/faq#error-url-issue).
