...
However, it is often more practical to fetch the value from an input component (e.g. [List input](/tool/user-inputs/text-list)) or 
another step output (e.g. [JavaScript](/tool/tool-steps/code-javascript) snippet producing a list of string). 
