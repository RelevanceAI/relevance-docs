...
However, it is often more practical to fetch the value from an input component (e.g. [JSON input](/tool/user-inputs/json)) or 
another step output (e.g. [String to JSON](/tool/tool-steps/convert-string-to-json)). 
