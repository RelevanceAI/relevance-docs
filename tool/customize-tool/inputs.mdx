...
OAuth account inputs can be used in tools that support OAuth authentication, or in Python code steps. For details on using OAuth accounts in Python code, see the [Python Tool step documentation](/tool/tool-steps/python-code/code-python#oauth-authentication).
