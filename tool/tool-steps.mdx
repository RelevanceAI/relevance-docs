...
<Columns cols={2}>
  ...
  <Card title="Delay" href="/tool/tool-steps/delay">
...
<Columns cols={2}>
  ...
  <Card title="Convert a file to text" href="/tool/tool-steps/file-to-text">
...
<Columns cols={2}>
  ...
  <Card title="Convert audio/video to text" href="/tool/tool-steps/convert-audio-video-to-text">
...
<Snippet file="components/integrations/linkedin-tool-steps.mdx" />
