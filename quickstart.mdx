...
To take advantage of LLMs, you'll need to configure integrations such as Open AI and/or Cohere. You can do this on the same page you got your API key from, or to re-open that page:
