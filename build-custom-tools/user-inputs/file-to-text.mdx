...
![Text inputs](/images/build-custom-tools/user-input/file-to-text-input-1.png)
...
![Text inputs](/images/build-custom-tools/user-input/file-to-text-input-details1.png)
