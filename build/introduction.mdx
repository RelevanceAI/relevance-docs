...
<Card title="Explore Invent" icon="wand-magic-sparkles" href="/build/invent">
...
<CardGroup cols={2}>
  <Card title="Build with Invent" icon="wand-magic-sparkles" href="/build/invent">
