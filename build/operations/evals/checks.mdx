...
This page is the reference for what each type scores. To attach one while building a Test, see [creating Tests](/build/operations/evals/test-sets).
...
Next: Learn how to [run Evals](/build/operations/evals/running-evaluations) against your Test sets.
