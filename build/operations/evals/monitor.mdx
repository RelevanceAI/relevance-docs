...
The **Monitor** section continuously scores live tasks against [Checks](/build/operations/evals/checks). Unlike the **Test** section, which runs simulated conversations, Monitor evaluates the real conversations your Agent or Workforce is having.
