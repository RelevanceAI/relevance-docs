...
7. Under **Checks**, attach the criteria this Test is scored against. Checks pass or fail, and are combined into the Test score.
   ...
   See [Check types](/build/operations/evals/checks) for what each type scores and the fields it takes.
...
Next: Read the [Check types](/build/operations/evals/checks) reference — what each type scores and how the Checks tab works.
