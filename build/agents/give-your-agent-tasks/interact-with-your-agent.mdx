...
When an agent creates or modifies files during a conversation, a **Files updated** bar appears above the chat input. Users can click **View files** to open the file viewer and inspect the output. For full details, see [Viewing agent-created files](/get-started/chat/introduction#viewing-agent-created-files).
