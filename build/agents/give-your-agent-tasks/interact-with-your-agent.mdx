...
You can now edit agent skills directly from Chat using the floating panel. This enables quick iterations while testing your agents without switching back to the Agent Builder.
