...
description: 'What each Check type scores, the fields it takes, and how the Checks library works'
---
...
<Steps>
  ...
  <Step title="Configure the type">
    Fill in the fields for that type — see [Check types](#check-types) above.
  </Step>
  <Step title="Save">
...
<AccordionGroup>
  <Accordion title="Does a Check made inside a test stay inside that test?">
    No. Creating one with **+ New check** while building a test saves it to the Checks library like any other, so you can attach it to other tests and to Monitor dashboards afterwards.
  </Accordion>
