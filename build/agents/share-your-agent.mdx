...
<Info>
When you publish changes to an agent that other agents, tools, or workforces depend on, a confirmation modal shows you all affected consumers before the change goes live. Learn more about [reviewing publish impact](/build/publishing/reviewing-publish-impact).
</Info>
