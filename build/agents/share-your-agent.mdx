...
<AccordionGroup>
  <Accordion title="Why can't I clone an agent that I originally cloned from the Marketplace?">
    ...
    If you need another copy of the agent, you can return to the [Marketplace](/get-started/marketplace/intro-to-marketplace) and clone the original listing again or add it to other projects directly from there.
  </Accordion>
  ...
  <Accordion title="Why can't I use Copy to Project on an agent I cloned from the Marketplace?">
    ...
    To add the agent to additional projects, visit the [Marketplace](/get-started/marketplace/intro-to-marketplace) and clone the original listing directly to each project where you need it.
  </Accordion>
</AccordionGroup>
