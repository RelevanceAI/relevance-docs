...
## Inventor building preferences

Inventor can remember your building preferences across agent-building sessions. When this feature is enabled, Inventor saves details about how you like to build and recalls them automatically the next time you use Inventor to create or modify an agent.

This is a per-user, opt-in setting — it is off by default and does not affect other users in your organization.

### How to enable

1. Open Inventor and click **About You** to open the About You modal
2. Toggle on **Remember my preferences**

### What gets saved

When enabled, Inventor saves:

- **Preferred AI models** — the models you tend to select when building agents
- **Naming conventions** — how you typically name agents, tools, and other resources
- **Workflow patterns** — recurring structural choices in how you set up agent workflows

These preferences are recalled across different agent-building sessions, so Inventor can apply your defaults without you having to specify them each time.
