...
You can view and manage stored memories using the [Manage Memories interface](#managing-your-memories) described below.

### Managing your memories

The Manage Memories interface in Inventor lets you view, search, edit, and delete your agent's stored Long-Term Memories without needing to interact with the agent directly.

{/* TODO: Add screenshot of Manage Memories interface overview */}

#### Accessing Manage Memories

1. Open **Inventor**
2. Click **About You** to open the About You modal
3. Click **Manage Memories**

#### Viewing your memories

The interface displays a scrollable list of up to 100 memory entries. Each entry shows the memory content and its last-modified date.

<Note>
All memories are stored, but the interface displays up to 100 entries at a time.
</Note>

#### Searching memories

Use the search bar at the top of the interface to find specific memories by searching through their content.

{/* TODO: Add screenshot of search functionality */}

#### Editing memories

1. Click the memory entry you want to edit
2. Make your changes directly in the text field
3. Click **Save** to apply the changes

{/* TODO: Add screenshot of inline editing */}

#### Deleting memories

1. Click the delete icon next to the memory entry you want to remove
