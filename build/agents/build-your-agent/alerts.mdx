...
This page covers agent-level alerts (status changes, tool errors, and publish events). For threshold-based alarms on Eval Monitor scores, see [Monitor alarms](/build/agents/build-your-agent/evals#monitor-alarms).
