...
You can pause and resume triggers from three places:
...
- **Inventor**: Ask Inventor to enable or disable individual triggers conversationally, if you have access to the [Inventor pilot](/build/invent/invent)

### Managing triggers with Inventor

If your account has access to [Inventor](/build/invent/invent), you can ask it to enable or disable individual triggers conversationally. This is an alternative to the UI controls — useful when you're already working in Inventor and want to adjust trigger states without switching context. Inventor is currently a limited pilot, so this route is not available to every account.
