...
- **Inventor** (Enterprise pilot): Ask Inventor to enable or disable individual triggers conversationally

### Managing triggers with Inventor

On Enterprise plans, you can ask [Inventor](/build/invent/invent) to enable or disable individual triggers conversationally. This is an alternative to the UI controls — useful when you're already working in Inventor and want to adjust trigger states without switching context.
