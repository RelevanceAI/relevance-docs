...
<Columns cols={3}>
  ...
  <Card title="SDK & API" href="/build/agents/build-your-agent/agent-triggers/sdk-and-api-triggers">Trigger your Agent using the SDK or API.</Card>
...
| Share trigger setup with my team | **Group Triggers** |
