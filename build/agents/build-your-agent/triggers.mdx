...
<Columns cols={2}>
  ...
  <Card title="Zapier" href="/build/agents/build-your-agent/agent-triggers/zapier">Use Zapier to trigger your Agent.</Card>
</Columns>
<Columns cols={2}>
  <Card title="API" href="/build/agents/build-your-agent/agent-triggers/api">Use the Relevance AI API to trigger your Agent.</Card>
