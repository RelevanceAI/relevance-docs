...
To create a brand new tool without leaving your agent's context:

1. In the **Tools** section, click **Build a tool from scratch**
2. Any unsaved changes to the agent are saved automatically before you leave. If the save fails, you stay on the Agent Builder and a warning appears — address the issue and try again.
3. The full [Tool Builder](/build/tools/create-a-tool) opens, where you define inputs, steps, and outputs for the new tool.
4. When you save the tool, it attaches to this agent automatically — you do not need to add it manually afterward.
