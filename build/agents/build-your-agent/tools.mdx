...
You can also swap tools directly from the prompt editor without navigating away — hover over a tool mention in the prompt and click **Swap**. See [Swap tools in your prompt](/build/agents/build-your-agent/prompt#swap-tools-in-your-prompt) for details.
