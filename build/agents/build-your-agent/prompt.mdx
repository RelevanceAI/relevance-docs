...
<Info>
  Your agent's prompt works alongside [Custom Instructions](/admin/project-management/custom-instructions), which provide persistent context across all agents and conversations. Custom instructions are set at the project or user level, while the prompt defines this specific agent's role and behavior.
</Info>
