...
### Visual Tool References

When you reference Tools or Actions in your prompt using the slash menu, they appear as visual pills with icons and readable names instead of raw text. This makes it easier to:

- See which tools are referenced in your prompt at a glance
- Identify tools by their icons and names
- Keep your prompt organized and readable

The visual pill editor is available both in the Agent Builder and when editing agent skills in Chat.
