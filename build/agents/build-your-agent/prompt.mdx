...
While writing your instructions, you can reference specific Tools (e.g., "Use the **Extract Text from PDF** tool to pull invoice data."). This tells the Agent exactly _which_ Tools to use when completing tasks.
