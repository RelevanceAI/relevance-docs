...
<Info>
**Invent a Prompt vs. Inventor v3:** The "Invent a Prompt" button generates a one-time prompt based on your description. **Inventor v3** (behind the `InventV3` feature flag) is a persistent conversational assistant that stays available throughout the entire build process, letting you modify your prompt and other Agent settings using natural language at any time.
</Info>
