...
The 'Tools as Triggers' feature allows users to create custom tools that can act as triggers for agents. This means you can combine data from various sources, like Salesforce and Airtable, to filter and process only the most relevant records. It’s designed to enhance your workflow by providing greater customisation and advanced logic.
