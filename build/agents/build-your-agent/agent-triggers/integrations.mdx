...
Native triggers are built directly into Relevance AI and available on all plans.

<Columns cols={2}>
  <Card title="Google Drive" href="/integrations/popular-integrations/google-drive#setting-up-triggers" icon="google">Trigger your Agent when files are created, modified, or deleted in Google Drive</Card>
</Columns>
