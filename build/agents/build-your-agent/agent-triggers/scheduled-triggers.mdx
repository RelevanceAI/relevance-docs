...
<Info>
  To view and manage all pending scheduled check-ins across your agents from one place, use the scheduled check-ins panel in [Inventor](/build/invent/invent).
</Info>
