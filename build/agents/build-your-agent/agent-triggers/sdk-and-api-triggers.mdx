...
<Note>
Looking to monitor evaluation metrics programmatically? The [Alarm System API](/build/agents/build-your-agent/evals/alarm-system-api) lets you create threshold-based alarms for evaluation scores, separate from triggering agents.
</Note>
