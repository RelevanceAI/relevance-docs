...
4. Click the **+ Add scenario** button to add a scenario to your test set. You can either start from a [scenario preset](#scenario-presets) or build one from scratch.
