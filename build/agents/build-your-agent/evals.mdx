...
<Tip>
  When Invent references a Monitor dashboard link in a conversation, it automatically renders an inline preview card showing the dashboard name, overall score, run count over the last 7 days, and a score-over-time chart. See [Monitor dashboard preview cards](/build/invent/invent) in the Invent docs.
</Tip>
