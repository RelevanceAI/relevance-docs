...
**Who it's for:** Anyone. No special plan or configuration is required beyond enabling the toggle.
...
<Warning>
Parallel Tool Calls is incompatible with "Continue same task" handovers. All connections from an agent with Parallel Tool Calls enabled must use "Create new task" as their Task Behavior. Connections that conflict with this requirement are highlighted in yellow in the Workforce Builder.
</Warning>

<Info>
Parallel Tool Calls is a Beta feature. Behavior and available options may change. See [Edge Settings](/build/workforces/build-an-ai-workforce/edge-settings) for details on configuring Task Behavior for workforce connections.
</Info>
