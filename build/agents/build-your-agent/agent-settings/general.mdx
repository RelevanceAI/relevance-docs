...
While agent settings control this specific agent's behavior, [Custom Instructions](/admin/project-management/custom-instructions) provide persistent context that applies across all agents and conversations. Custom instructions can be set at the project level (by admins) or user level (by individual users) to ensure consistent behavior without modifying individual agent configurations.

**Key differences:**
- **Agent settings:** Configure this specific agent's behavior and capabilities
- **Custom instructions:** Add persistent context that applies to all agents you interact with
