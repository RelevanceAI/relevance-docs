...
## Meeting Notetaker Agent vs Desktop App

Relevance AI offers two ways to record and transcribe meetings. Choose the approach that fits your needs:

<CardGroup cols={2}>
  <Card title="Meeting Notetaker Agent" icon="robot">
    Cloud bot that joins meetings as a visible participant
  </Card>
  <Card title="Desktop App" icon="desktop" href="/get-started/desktop-app/introduction">
    Local recording on your Mac, invisible to other participants
  </Card>
</CardGroup>

### When to use each approach

| Feature | Meeting Notetaker Agent | Desktop App |
|---------|------------------------|-------------|
| **Recording method** | Cloud bot joins meeting | Local recording on your device |
| **Visibility** | Visible as meeting participant | Invisible to other participants |
| **Platform support** | Zoom, Google Meet, Teams | Any meeting platform |
| **Automation** | Automatic via calendar triggers | Automatic meeting detection |
| **Distribution** | Send summaries to Slack, email, CRM | Sync to your Relevance AI account |
| **Best for** | Team-wide automation & distribution | Personal recording & privacy |
| **Setup** | Connect calendar + configure triggers | Install app + grant permissions |

<Tip>
Use the **Meeting Notetaker Agent** when you need automated meeting attendance and team-wide distribution of summaries. Use the **[Desktop App](/get-started/desktop-app/introduction)** when you want private, local recording that works with any platform.
</Tip>
