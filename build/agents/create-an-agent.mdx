...
Inventor is available from anywhere in the Relevance platform via a floating action button. Click it to open the Inventor side panel without leaving your current page.

The side panel stays open as you navigate between pages. Your conversation context and chat history are preserved for the duration of your session, so you can continue where you left off after browsing other sections of the platform.

Inventor works on tablet and desktop screens.

<Note>
The always-available Inventor side panel requires the InventV3 feature flag. Contact your account team to enable it.
</Note>
...
You can open Inventor from the floating action button anywhere in the platform, or navigate to it through the Agents page:
