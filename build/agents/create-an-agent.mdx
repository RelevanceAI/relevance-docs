...
<Note>
You can set up an "About You" profile in Inventor settings so your role and context are automatically included in every session. See [Personalize Inventor](/build/agents/personalize-inventor).
</Note>
