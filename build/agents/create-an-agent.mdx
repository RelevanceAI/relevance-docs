...
<Info>
Inventor is also available within Evals to debug failing Checks. Once you've run an evaluation, click Fix on any failing Check to open Inventor pre-populated with the conversation and Check details. See [AI-assisted debugging with Inventor](/build/agents/build-your-agent/evals#ai-assisted-debugging-with-inventor).
</Info>
