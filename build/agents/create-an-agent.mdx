...
## Editing Agents in Chat

Once you've created an agent, you can also edit its skills directly from Chat. This lets you make quick adjustments while testing your agent without switching back to the Agent Builder.

<Card title="Edit Agent Skills in Chat" icon="comments" href="/get-started/chat/edit-agent-skills">
