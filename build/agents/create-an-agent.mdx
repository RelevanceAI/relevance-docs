...
<Note>
  If you see a **Talk to Inventor** button in the Inventor panel, you can describe what to build by speaking instead of typing. This voice interview mode is experimental and available to select users. See [voice interview mode](/build/invent/invent#voice-interview-mode) for details.
</Note>
