...
```
  ...
  <Tab title="Advanced knowledge search (2m)" id="advanced-knowledge-search-2m-context" icon="wand-magic-sparkles">
    ...
    <div style={{ width:"100%",position:"relative","padding-top":"56.75%",paddingTop:"75%" }}>
    <iframe src="https://app.supademo.com/embed/cmcwogmal1l5n9emp09x9eqv7" frameBorder="0" title="Add the Advanced Knowledge Search (2m) Tool step to your Tool" allow="clipboard-write; fullscreen" webkitAllowFullscreen="true" mozAllowFullscreen="true" allowFullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px",objectFit:"cover" }} />
