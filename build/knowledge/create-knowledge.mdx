...
## Sharing a Knowledge Table

<Note>
Knowledge Table sharing is available for Enterprise organizations with fine-grained access controls (FGA) enabled. Contact your Relevance AI sales representative to enable this feature.
</Note>

In enterprise FGA organizations, admins can control which users can read a specific Knowledge Table. The **Share** button on each Knowledge Table page opens a modal where you can add or remove individual users.

### Grant or revoke access

1. Navigate to **Knowledge** and open the Knowledge Table you want to share.
2. Click **Share** in the top-right corner of the page.
3. Search for the user by name or email address.
4. Select the user to grant them read-only access to that Knowledge Table.
5. To revoke access, find the user in the list and remove them.

<Note>
Only individual user permissions are supported for Knowledge Tables. Group-based permissions are not available.
</Note>
