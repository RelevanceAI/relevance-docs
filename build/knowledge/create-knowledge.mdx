...
<Tip>
  Want a guided path through setting up knowledge? [Relevance AI Academy](https://relevanceai.com/academy) has structured courses that walk you through agents, tools, and workforces step by step.
</Tip>