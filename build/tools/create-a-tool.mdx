...
<Note>You can also invent a tool directly from the agent builder's tool selection modal without leaving your agent. See [AI-powered tool invention](/build/agents/build-your-agent/tools#ai-powered-tool-invention).</Note>
