...
- [Custom Tool checks](/build/agents/build-your-agent/evals#check-types) — use a tool as an evaluator in the Evals system by giving it a `conversation` input and a `passed` boolean output
