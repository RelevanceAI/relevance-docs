...
This guide walks you through creating a Tool. For an overview of what Tools are and how they work, see [Tools](/get-started/core-concepts/tools). You can also reach the canonical Tool Builder from the Agent Builder — click **Open editor** on any tool attached to an Agent to open it directly.

## Three ways to create

<CardGroup cols={3}>
  <Card title="Invent" icon="wand-magic-sparkles" href="#option-1-invent-a-tool">
  ...
  <Card title="Build from scratch" icon="hammer" href="#option-2-build-from-scratch">
  ...
  <Card title="From the Agent Builder" icon="robot" href="#option-3-from-the-agent-builder">
    Create a new Tool directly from an Agent's Tools section. The new Tool is automatically attached to the Agent when saved.
  </Card>
</CardGroup>
...
## Option 3: From the Agent Builder

You can create a new Tool directly from the Agent Builder without navigating away from your agent.

1. In the Agent Builder, navigate to the **Tools** section
2. Use the option to add a new tool and select to create one from scratch
3. The Tool Builder opens in the current tab
4. Build your Tool as described in [Option 2: Build from scratch](#option-2-build-from-scratch)
5. Save the Tool — it is automatically attached to the Agent you started from
