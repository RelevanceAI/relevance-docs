...
<Columns cols={2}>
  <Card title="Prompt injection detection" href="/build/tools/tool-steps/prompt-injection-detection">
    Detect prompt injection attempts in text using ML-based classification
  </Card>
</Columns>