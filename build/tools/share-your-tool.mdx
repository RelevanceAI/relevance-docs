...
The tool list displays visual indicator pills next to tool names so you can see which sharing options are active at a glance.

- **Embeddable** — a sharable link or embed is enabled. Anyone with the link can run the tool using your credits.
- **Cloneable** — the Cloneable Template option is enabled. Anyone with the link can clone the tool into their own workspace.
