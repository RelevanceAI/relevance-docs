...
<Note>
CSV files added to an agent's [Context](/build/agents/build-your-agent/context) are displayed as scrollable tables in the builder, so you can verify the data before running the agent. For structured processing, this tool step converts the file to JSON that your tools can use.
</Note>