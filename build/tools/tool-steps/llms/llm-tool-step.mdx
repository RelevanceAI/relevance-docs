...
Some Claude models use adaptive thinking and adjust their reasoning depth automatically, with effort levels up to high and max. You can also influence reasoning through the system prompt.
