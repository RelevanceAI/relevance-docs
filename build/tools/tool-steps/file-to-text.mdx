...
<Note>
If you want to make a file available to your agent without a tool step, use [Context](/build/agents/build-your-agent/context) to attach files directly to the agent's context window.
</Note>