...
For complete documentation on the `Integration` class, including detailed examples, method parameters, and best practices, see the [Python Helper Functions documentation](/build/tools/tool-steps/python-code/code-python-helper-functions#integration).

<Note>
While Python code steps can use OAuth authentication through the Integration helper class, they do not support [User Level Authentication](/enterprise/user-level-authentication). If you need individual users to authenticate with their own accounts, you should use dedicated OAuth-based tool steps instead of Python code.
</Note>
...
<Columns cols={2}>
  <Card title="Helper Functions" href="/build/tools/tool-steps/python-code/code-python-helper-functions">
    Access functions that can help you code Python Tool steps
  </Card>

  <Card title="Transformations" href="/build/tools/tool-steps/python-code/code-studio-transformation-python-helper-functions">
