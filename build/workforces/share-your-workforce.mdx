...
The workforce list displays visual indicator pills next to workforce names so you can see which sharing options are active at a glance.

- **Embeddable** — an embed option (Chat UI or Chat Widget) is enabled. Anyone with the link can interact with the workforce using your credits.
- **Cloneable** — the Cloneable Template option is enabled. Anyone with the link can clone the workforce into their own workspace.
