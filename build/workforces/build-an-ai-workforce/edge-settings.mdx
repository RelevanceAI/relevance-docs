...
**Q: How do I know if I should use "AI connection" or "Next step"?**\
A: Use **AI connection** when you want the agent to decide whether to use the connection based on context and natural language instructions. Use **Next step** when one node should always pass control to another regardless of context.
