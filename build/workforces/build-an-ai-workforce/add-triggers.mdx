...
<Tip>
For teams using integration triggers, consider [Group Triggers](/build/agents/build-your-agent/agent-triggers/group-triggers) to share trigger configurations while team members use their own OAuth accounts.
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="What are Group Triggers?">
    Group Triggers allow admins to create shared trigger configurations that team members can join by connecting their own OAuth accounts. This is useful for teams where multiple members need the same trigger setup. Learn more about [Group Triggers](/build/agents/build-your-agent/agent-triggers/group-triggers).
  </Accordion>
  <Accordion title="How do I test my triggers?">
    ...
    **For Manual and Integration Triggers:**
    ...
    4. Monitor the execution in the [Workforce Task View](https://relevanceai.com/docs/build/workforces/workforce-features/workforce-task-view) to verify proper activation
    ...
    **Checking Logs and Error Messages:**
    ...
    1. **Workforce Task View:** Navigate to the "Task" section in your Workforce to view:
       ...
       - [Learn more about Workforce Task View](https://relevanceai.com/docs/build/workforces/workforce-features/workforce-task-view)

    2. **Tool Logs:** Within individual tools, access the "Logs" tab to view execution details. [Learn more about Tools](https://relevanceai.com/docs/get-started/core-concepts/tools)

    3. **Agent Task History:** For agents with recurring schedules, view error details in the agent's task history. [Learn more about Agent Triggers](https://relevanceai.com/docs/build/agents/build-your-agent/triggers)
