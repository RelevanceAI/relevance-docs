...
- **Decide when to use**: The agent determines when to involve another agent based on natural language instructions
- **Next step**: The first agent always passes the task to the second agent
