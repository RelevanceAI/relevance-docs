...
Use [Evals](/build/agents/build-your-agent/evals) to automatically evaluate workforce performance:

- Set up evaluation rules to test multi-agent workflows end-to-end
- Monitor agent handoffs and context preservation
- Track quality metrics across your workforce conversations
- Identify areas for improvement in your multi-agent workflows
...
- Use Evals to automatically monitor quality across your workforce conversations
...
- [Evals](/build/agents/build-your-agent/evals): Test and evaluate your workforce performance with automated evaluations
