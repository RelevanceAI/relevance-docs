...
When multiple tasks are waiting on the same tool, the Approvals tab groups them by the pending tool and the owning agent. This lets you assess the volume of pending work by tool and agent before drilling into individual tasks, rather than reviewing each one separately.
...
5. Use the pending approval grouping in the Approvals tab to surface all tasks waiting on tool approval, organized by the tool and agent responsible

<Note>
For bulk actions on pending approval groups — such as approving or rejecting all tasks in a group at once — use the [Task Operations page](/build/agents/give-your-agent-tasks/tasks-page).
</Note>
...
- [Edge Settings](https://relevanceai.com/docs/build/agents/customise-agent/flowbuilder): Configure how agents communicate and interact with each other in your workforce
