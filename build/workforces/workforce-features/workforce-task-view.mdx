...
<Tip>
If you have [Visual data masking](/build/agents/build-your-agent/agent-settings/general#visual-data-masking) enabled on any agents in your workforce, PII (emails, phone numbers, credit cards) will be automatically replaced with placeholders in the conversation history view. This helps protect sensitive information while still allowing you to review task progress.
</Tip>
