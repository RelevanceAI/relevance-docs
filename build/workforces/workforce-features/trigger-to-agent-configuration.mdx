...
- [Agent to Agent Configuration](/build/workforces/workforce-features/agent-to-agent-configuration): Connect agents to create multi-step workflows
- [Agent to Tool Configuration](/build/workforces/workforce-features/agent-to-tool-configuration): Enable agents to use tools to complete tasks
- [Workforce Task View](/build/workforces/workforce-features/workforce-task-view): Monitor and manage tasks initiated by triggers
