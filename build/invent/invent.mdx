...
<CardGroup cols={2}>
  ...
  <Card title="Build and improve evals" icon="flask-vial" href="/build/agents/build-your-agent/evals">
    Diagnoses errored logs and tools, explains why a run failed, and proposes how to fix it — so you can build stronger evals. Inventor can also manage pre-publish quality gates directly, including creating, updating, and removing gate configuration.
  </Card>
