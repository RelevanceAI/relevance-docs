...
<Tabs>
  ...
  <Accordion title="Restore a version" icon="clock-rotate-left">
    ...
    Invent always asks you to confirm before restoring, and requires a version description so the restored state is easy to identify later. For a full guide to version history — including how to restore from the UI and how retention works — see [Version history](/build/agents/build-your-agent/version-history).
  </Accordion>
    </AccordionGroup>
  </Tab>
</Tabs>
