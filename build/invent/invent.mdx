...
<Tabs>
  ...
  <Accordion title="Connect integrations" icon="plug">
    The **Connect** button in the Inventor composer toolbar opens an integrations menu so you can connect third-party services without leaving your conversation.

    The menu lists available integrations including Gmail, Slack, HubSpot, Salesforce, Jira, Notion, and more. Integrations you've already connected appear at the top with a green checkmark. Use the search field to find a specific integration, or click **View all** to go to the full integrations page.

    Clicking an unconnected integration opens the OAuth flow in a popup. Your draft message is preserved while the popup runs, so you can complete authentication and return to your conversation without losing what you were typing.

    Connected integrations are immediately available for Invent to use in the current session. This feature is available to all users.
  </Accordion>
