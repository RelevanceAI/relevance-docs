...
<Tabs>
  <Tab title="Clarifying questions">
    Before building, Inventor may ask you one or more questions to clarify your requirements. These appear as structured choice cards — not chat messages — so you can make decisions quickly without writing out a full explanation.

    <Info>
      This feature is rolling out gradually and may not yet be available in your account.
    </Info>

    Each question presents 2–4 tappable options. The first option is marked **Recommended** to indicate the most common choice for your use case.

    <CardGroup cols={2}>
      <Card title="Skip" icon="forward">
        Skip any question you don't want to answer. Inventor proceeds with its best judgment for skipped questions.
      </Card>
      <Card title="Something else" icon="pen">
        If none of the preset options fit, select **Something else** to type a free-text answer instead.
      </Card>
      <Card title="Progress indicator" icon="circle-dot">
        A dot pager shows how many questions there are and how many you've answered so far.
      </Card>
      <Card title="Timeline" icon="clock">
        Your answers are recorded in the conversation timeline so you can see which decisions shaped the build.
      </Card>
    </CardGroup>
  </Tab>
