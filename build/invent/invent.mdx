...
<Tabs>
  ...
  <Accordion title="Connected accounts" icon="plug">
    The Invent chat includes a connectors toolbar in the floating column. Clicking any connector in the toolbar, or any connected account row, opens an integration management drawer inline — without leaving the conversation.

    From the drawer you can add a new integration, rename a connected account, reconnect one whose credentials have expired, or remove an account you no longer need. Click **Back** to return to the conversation.

    This lets you manage integrations without navigating to the **Integrations & API Keys** page in the left-hand menu.
  </Accordion>
