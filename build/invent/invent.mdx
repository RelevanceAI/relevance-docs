...
<Tabs>
  ...
  <Accordion title="Browser notifications" icon="bell">
    Browser notifications alert you when an Invent turn finishes, even if you've switched to another tab or app. Clicking a notification focuses the browser and takes you directly to that conversation.
    ...
    <Steps>
      ...
      <Step title="Open General">
        Select **General**, then set your preferred mode under **Notifications**.
      </Step>
      <Step title="Grant browser permission">
        The first time you enable notifications, your browser or OS asks for permission. Grant it to receive push notifications.
      </Step>
    </Steps>

    | Mode | What triggers a notification |
    | --- | --- |
    | **Off** | No notifications. |
    | **Needs attention** | Notifies you for approvals, question rounds, and errors only. |
    | **All messages** | Notifies you after every Invent turn completes. |

    When you have multiple tabs open, only one notification fires per turn. Notifications are suppressed while you're already viewing the Invent panel.

    <Note>
      After your first message in a new conversation, Invent shows an opt-in prompt to help you discover notifications if you haven't enabled them yet.
    </Note>
  </Accordion>
