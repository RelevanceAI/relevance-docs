...
Need to create a similar agent with modifications? You can duplicate agents using two methods:

<CardGroup cols={2}>
  <Card title="Copy to Project" icon="copy">
    **Fastest method:** Click the three-dot menu (⋮) next to any agent in your agents list and select "Copy to Project". This creates a complete copy in just a few clicks.
  </Card>
  <Card title="Clonable Template" icon="share-nodes">
    **For sharing:** Create a shareable clone link via the Share button. You can use this link yourself to duplicate agents or share with others.
  </Card>
</CardGroup>

<Tip>
Learn more about duplicating agents, including detailed steps and use cases, in [How to Duplicate or Clone an Agent](/agent/duplicate-agent).
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="What is concurrency and how does it affect my agents?">
    Concurrency refers to the number of tasks that can be executed simultaneously by your agents. For more details, visit our [System Quotas page](/get-started/system-limits).
  </Accordion>
  ...
  <Accordion title="How can I organize my Agents?">
    ...
    - **Duplicate agents**: Create copies of agents for testing or variations using [Copy to Project](/agent/duplicate-agent)
    
    These organizational features help you manage large collections of Agents efficiently.
  </Accordion>
  
  <Accordion title="Can I duplicate or copy an agent?">
    Yes! Relevance AI offers two methods to duplicate agents:
    
    1. **Copy to Project** (recommended): Click the three-dot menu next to any agent and select "Copy to Project" for a quick, one-step duplication
    2. **Clonable Template**: Create a shareable clone link that you can use yourself or share with others
    
    Both methods preserve your agent's configuration, tools, and settings. Learn more in [How to Duplicate or Clone an Agent](/agent/duplicate-agent).
  </Accordion>
</AccordionGroup>
