...
Agents are powerful AI assistants that are empowered with Large Language Models capabilities, Tools and Skills and 
Knowledge and data that you as the domain expert provide them.

Skills (i.e. [Tools](/get-started/key-concepts/tools)) are designed to target different goals and address different 
challenges. Relevance platform brings such a flexibility and a huge range of analysis step, that enables you to design 
and productionize Skills/Tools required to tackle your company and use case-specific challenges. You are not limited
