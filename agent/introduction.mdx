...
<AccordionGroup>
  ...
  <Accordion title="What is concurrency and how does it affect my agents?">
    Concurrency refers to the number of tasks that can be executed simultaneously by your agents. Understanding concurrency is crucial for optimizing performance, especially during high-traffic periods. For more details, visit our [System Quotas page](/get-started/system-limits).
  </Accordion>
</AccordionGroup>
