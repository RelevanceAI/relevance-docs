...
## Duplicate Your Own Agent

Looking to duplicate an agent for yourself? The fastest way is using the **"Copy to Project"** feature:
...
<Steps>
  ...
  <Step title="Click the three-dot menu">
    Find the agent you want to duplicate and click the three-dot menu (⋮) next to it
  </Step>
  <Step title="Select Copy to Project">
    Choose "Copy to Project" from the dropdown menu and select your destination project
  </Step>
</Steps>

<Tip>
For detailed instructions on duplicating agents, including using clonable templates for self-duplication, see [How to Duplicate or Clone an Agent](/agent/duplicate-agent).
</Tip>
...
<Note>
**Duplicate your own agent:** You can use the clone link yourself to create a copy of your own agent. This is useful for creating variations or backups. For a faster method, use [Copy to Project](/agent/duplicate-agent) instead.
</Note>
...
<CardGroup cols={2}>
  <Card 
    ...
    icon="copy" 
    href="/agent/duplicate-agent"
  >
    Learn how to duplicate agents for yourself using Copy to Project or Clonable Templates
  </Card>
  <Card 
