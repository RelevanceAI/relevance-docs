...
In the above example, we have created an agent called "Email Follow-Up FAQ Agent", whose responsible for handling customer queries over email, and escalating to Slack (a person) when it doesn't know the answer to a question.
