...
In the above example, we have created an agent called "Email Follow-Up FAQ Agent", who is reponsible responsible for handling customer queries over email, and escalating to Slack (a person) when it doesn't know the answer to a question.
...
If you are technical, you can use the Python, JavaScript or API Block steps to interact with any software you can write code to interact with.
