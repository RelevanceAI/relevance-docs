...
(*At Relevance, we have a happy onboarding ritual where we give our agents a cute new pixel profile pic when they've passed their probation period and are ready to work with us!*)
...
Just like in the Matrix where [Neo instantly learned kung fu](https://www.youtube.com/watch?v=0YhJxJZOWBw) just by downloading a program, agents can learn new superpowers just by equipping them with skills or domain expertise.

In fact, here's how easy it is to teach Neo some Kung Fu skills instantly just using tools! 🤯🥋
...
<div
  ...
  <iframe
    src="https://player.vimeo.com/video/950933530"
    frameBorder="0"
    scrolling="no"
    style={{
      position: 'absolute',
