...
<CardGroup cols={2}>
  <Card title="Introduction to Triggers" icon="bolt" href="/agent/build-your-agent/triggers">
    Learn about all the ways to trigger your agents
  </Card>
  <Card title="Scheduled Messages" icon="clock" href="/agent/build-your-agent/scheduled-messages">
