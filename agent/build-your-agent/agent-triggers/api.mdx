...
<Warning>
The Relevance AI API is officially supported for triggering Agents and Tools only. All other API usage is currently unsupported, though we're working to bring more functionality into our agents over time.
</Warning>
