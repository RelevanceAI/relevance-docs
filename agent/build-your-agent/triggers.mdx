...
We have many different ways you can trigger your Agent, with 200+ integrations supported. Some of our most popular triggers include:
...
- **Build your own triggers**
  ...
  4. [Tools as a Trigger](../../integrations/agent-integrations/build-your-own-triggers/tools-as-triggers)
