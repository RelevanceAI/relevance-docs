...
<Card 
  ...
  horizontal
>
  Enable your agents to schedule future messages and restart conversations at specific times. Unlike other triggers that start new runs, Scheduled Messages restart existing conversations with full context. Perfect for follow-ups, reminders, and multi-step sequences. **Available on Pro plan and above.**
</Card>

<Tip>
**New to Scheduled Messages?** Check out our [comprehensive guide](/agent/build-your-agent/scheduled-messages) to learn how to set up proactive follow-ups, reminders, and time-based communication sequences.
</Tip>
