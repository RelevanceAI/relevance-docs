...
For each Trigger, simply connect your associated account. For more information about how to setup available triggers, Click on the articles you're interested in.
