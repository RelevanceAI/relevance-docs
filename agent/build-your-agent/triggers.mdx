...
<Warning>
After configuring any trigger, you must publish your agent for the trigger to become active. Triggers will not work until your agent is published.
</Warning>
...
<Info>
Remember: After adding or modifying any trigger, click the "Publish" button to make your changes live. Learn more about [publishing your agent](/agent/build-your-agent/agent-settings/publishing).
</Info>
...
6. **Publish your agent** to activate the schedule
...
- **Don't forget to publish**: Schedules only become active after you publish your agent
...
<AccordionGroup>
  ...
  <Accordion title="How do I change an existing schedule?">
    Go back to the Recurring Schedule section in your agent's Triggers settings and update the schedule as needed. Changes take effect immediately after you publish your agent.
  </Accordion>
...
5. **Publish your agent** to activate scheduled messages
