...
Once you've finished configuring all the pieces, click the **Publish** button to make your agent live. Publishing activates your triggers, applies your configuration changes, and makes your agent ready to take on tasks and deliver results!

<Info>
Any time you make changes to your agent's configuration (including triggers, tools, or settings), you must publish your agent for those changes to take effect. Learn more about [publishing your agent](/agent/build-your-agent/agent-settings/publishing).
</Info>
