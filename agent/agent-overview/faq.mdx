...
<Warning>
  **This page has been deprecated.** All FAQ content has been consolidated into the [Agent Introduction page](/agent/agent-overview/introduction#frequently-asked-questions) for a better user experience. Please refer to that page for all frequently asked questions about agents.
</Warning>

---

## Redirecting to Agent Introduction

For the most up-to-date FAQ content, please visit:

<Card 
  title="Agent Introduction - FAQ Section" 
  icon="circle-question" 
  href="/agent/agent-overview/introduction#frequently-asked-questions"
>
  View all frequently asked questions about AI agents in one place
</Card>

---

## Legacy FAQ Content (For Reference Only)

<Note>
  The content below is maintained for reference purposes only. Please refer to the [Agent Introduction page](/agent/agent-overview/introduction#frequently-asked-questions) for the current FAQ section.
</Note>
