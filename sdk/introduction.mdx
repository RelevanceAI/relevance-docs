...
If you just need to fire a one-off webhook or call from a language the SDK doesn't support, use the [API trigger](/build/agents/build-your-agent/agent-triggers/sdk-and-api-triggers) instead.
