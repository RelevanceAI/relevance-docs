...
5. Explicitly note constraints and goals
...
6. For large prompts, note the goals and important instructions closes to the end of the prompt.
This is mostly valid for large prompts. It is best to 