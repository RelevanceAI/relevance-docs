...
<Note>
Project admins can create [Group Triggers](/build/agents/build-your-agent/agent-triggers/group-triggers) that allow team members to share trigger configurations while using their own OAuth accounts.
</Note>
