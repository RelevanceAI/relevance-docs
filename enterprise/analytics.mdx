...
The Agent Pulse panel displays a live sparkline of agent invocations per minute, giving you a real-time view of activity across your AI workforce.

Use the toggle controls to switch between the **5**, **15**, and **60-minute** time windows. The sparkline updates to reflect the selected window.

Clicking the sparkline opens the task list filtered to the selected time window, so you can immediately inspect the tasks driving the current activity.
