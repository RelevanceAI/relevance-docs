...
<CardGroup cols={2}>
  ...
  <Card title="By project" icon="chart-bar">
    Breaks the bars down by project, with each project in a distinct colour and its own running and queued bands.
  </Card>
</CardGroup>
...
<Note>
  The "Org total" / "By project" toggle is only available to organization managers. Other members see the organization total.
</Note>
