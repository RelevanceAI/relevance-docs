...
## User Level Authentication vs. Group Triggers
...
Learn more about [Group Triggers](/build/agents/build-your-agent/agent-triggers/group-triggers).
...
<AccordionGroup>
  ...
  <Accordion title="How is this different from Group Triggers?">
    User Level Authentication is for tool authentication (what data an agent can access during execution), while Group Triggers are for trigger setup (when an agent runs). User Level Authentication determines which user's data the agent accesses when using tools, while Group Triggers determine which events activate your agent. You can use both features together in the same agent. Learn more about [Group Triggers](/build/agents/build-your-agent/agent-triggers/group-triggers).
  </Accordion>
</AccordionGroup>
