...
- [Visual data masking](/build/agents/build-your-agent/agent-settings/general#visual-data-masking) automatically replaces PII with placeholders in conversation history views
