...
<Tabs>
  <Tab title="New billing (Actions and Vendor Credits)">
    ...
    - On the **Analytics** page: open an agent, then click the **Analytics** tab. The chart shows the same organization-wide concurrency data, so you can correlate agent activity with overall concurrency patterns.
