...
To bypass Vendor Credits entirely, you can bring your own API keys. On paid plans, BYOK is an optional way to skip Vendor Credits while still having them available. The Free plan is BYOK only — there are no included Vendor Credits.
...
The Free plan does not include Actions or Vendor Credits. Free users must bring their own API keys (BYOK) to use LLM capabilities. To get included Actions and Vendor Credits, upgrade to Pro or Team.
...
<AccordionGroup>
  ...
  <Accordion title="Can I bring my own API keys to bypass Vendor Credits?">
    Yes! You can bring your own API keys to bypass Vendor Credits entirely. On paid plans, BYOK lets you skip Vendor Credits while still having them available as a fallback. The Free plan is BYOK only — there are no included Vendor Credits, so you must bring your own keys to use AI features.
  </Accordion>
