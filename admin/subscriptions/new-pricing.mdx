...
To bypass Vendor Credits entirely, you can bring your own API keys. The Free plan is now BYOK only — there are no included Vendor Credits.
...
<AccordionGroup>
    ...
    <Accordion title="I'm a free user, what exactly is going to happen to me?">
        <Note>
          The Free plan has since been further updated. It is now BYOK only — there are no included Actions or Vendor Credits. See the current [pricing page](/get-started/pricing) for up-to-date information. The original September 2025 transition details are below for reference.
        </Note>
...
<AccordionGroup>
    ...
    <Accordion title="Can I bring my own API keys to bypass Vendor Credits?">
        Yes! You can bring your own API keys to bypass Vendor Credits entirely. The Free plan is now BYOK only — there are no included Vendor Credits. On paid plans, BYOK is optional and lets you skip Vendor Credits while still having them available.
    </Accordion>
</AccordionGroup>
