...
<AccordionGroup>
    ...
    <Accordion title="I'm a free user, what exactly is going to happen to me?">
        The Free plan is now BYOK only — there are no included Actions or Vendor Credits. To use AI features, you must bring your own LLM API keys. To get included Actions and Vendor Credits, upgrade to Pro or Team.
    </Accordion>
