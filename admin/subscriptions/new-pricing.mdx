...
<Warning>
  The Free plan no longer includes Actions or Vendor Credits. Free users must bring their own LLM API keys to use AI features, or upgrade to Pro or Team.
</Warning>
...
To bypass Vendor Credits entirely, you can bring your own API keys. The Free plan is BYOK only — there are no included Vendor Credits.
...
<AccordionGroup>
    ...
    <Accordion title="I'm a free user, what exactly is going to happen to me?">
        The Free plan is BYOK only — there are no included Actions or Vendor Credits. To use AI features, you must bring your own LLM API keys. To get included Actions and Vendor Credits, upgrade to Pro or Team.
    </Accordion>
...
<AccordionGroup>
    ...
    <Accordion title="Can I bring my own API keys to bypass Vendor Credits?">
        Yes! You can bring your own API keys to bypass Vendor Credits entirely. The Free plan is BYOK only — there are no included Vendor Credits. On paid plans, BYOK is optional and lets you skip Vendor Credits while still having them available.
    </Accordion>
</AccordionGroup>
