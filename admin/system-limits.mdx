...
<Info>
You can query your organization's concurrency usage over time using the [Analytics API](/admin/analytics-api/concurrency-time-series). This allows you to monitor usage patterns, identify peak periods, and plan capacity programmatically.
</Info>
