...
<Note>
This page covers credit and action usage alerts (billing notifications). Relevance AI also has [agent alert rules](/build/agents/build-your-agent/alerts) for execution events like task failures, and [evaluation alarms](/build/agents/build-your-agent/evals#alarms) for quality metric monitoring.
</Note>
