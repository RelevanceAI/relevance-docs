...
2. Set up an enrichment for sentiment analysis:
    * Select your data table and on the [Data table](/get-started/key-concepts/knowledge) page, click on the `Enrich` button on the top left
    ...
    * Run the analysis on single entries (e.g. hover over the first row and click on play) or on the whole table by clicking on the 
    ...
    More detailed explanation about bulk run can be found [here](/build/tools/bulk-run)
...
be downloaded to your computer download folder in a few seconds (more details available at [Export results](/build/tools/export))
