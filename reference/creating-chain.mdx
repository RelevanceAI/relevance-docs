...
Let's create: `chains/hello-world.ts`.
...
You can add anything from with the setup function into this return object. For example, if you wanted to return the `pdf_url` you could add return:
