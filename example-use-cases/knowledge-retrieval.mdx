---
title: 'Knowledge retrieval: Find the best matching answer to a question using knowledge'
sidebarTitle: 'Knowledge retrieval'
description: 'Use LLMs to retrieve the best matching answer from a knowledge source'
---
...
For more information see [how to create a tool](/custom-tools/introduction).
2. Click on `+ Add data` on the knowledge section to [add knowledge](/custom-tools/knowledge/knowledge) to your Tool. 
...
3. Add a [text input](/custom-tools/user-inputs/text-input) component which will carry the query/question. Lets call
it `query`. Your Tool must be similar to the image below.
![knowledge and input](/images/tools/use-cases/knowledge-retrieval-1.png)
4. Add an [LLM](/custom-tools/tool-steps/llms/llm) component.
* **The prompt**
...
* **Handling large amount of data**
    ...
    set it up manually. 
    ![knowledge and input](/images/tools/use-cases/knowledge-retrieval-2.png)
    ...
    [How to handle too much text](/custom-tools/tool-steps/llms/how-to-handle-too-much-text).
...
* **Output**
    ...
    ![knowledge and input](/images/tools/use-cases/knowledge-retrieval-3.png)

5. Save the Tool using the button on the top right of the page and you are ready to enter you query and get
responses from your knowledge retrieval LLM.

![knowledge and input](/images/tools/use-cases/knowledge-retrieval-4.png)