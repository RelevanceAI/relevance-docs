...
Slide Builder is an inbuilt AI Agent in Relevance Chat that allows you to create AI-generated slides and present them. You can create Slides from a simple prompt, using the OpenAI Deep Researcher inbuilt agent to search a query first, or by using any of your Agents / Workforces to generate an output then create Slides of it. 
...
2. **Plan your Content and Slide Design**: Look at [Generate Content and Designing Slides](/chat/slide-builder#generating-content-and-designing-slides) for tips.
...
1. **Generate Content using Prompts**: Tell Slide Builder what content you want on your slide deck. Alternatively, use the '@' to integrate your Relevance AI agent or an inbuilt AI agent!
