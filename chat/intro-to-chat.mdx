...
Simply @ mention any Agent you have access to in your project, and Chat will seamlessly integrate their capabilities into your conversation. The @ menu also provides access to saved prompts, making it easy to use both Agents and standardized prompt templates in your workflow.

---

## Using Saved Prompts in Chat
...
<iframe 
  src="https://www.loom.com/embed/91ff0d9102a04625ae4709ed1ec16124" 
  frameBorder="0" 
  allowFullScreen
  style={{ width: "100%", height: "400px", borderRadius: "10px" }}
></iframe>

### Who can create and manage saved prompts?

**Editors** have full control over saved prompts in their project:
- Create new saved prompts
- Edit existing saved prompts
- Delete saved prompts

### Who can use saved prompts?

**All users** in the project can access and use saved prompts in their Chat conversations, regardless of their role. This ensures that everyone benefits from standardized, high-quality prompts created by your team's Editors.

### How to access saved prompts

Saved prompts are available through the @ menu when creating a new chat:

<Steps>
  <Step title="Open the Create New Chat page">
    Start a new conversation in Relevance Chat
  </Step>
  <Step title="Type @ to open the menu">
    In the chat input field, type the @ symbol to open the mention menu
  </Step>
  <Step title="Browse or search for saved prompts">
    Scroll through the list or type to search for the saved prompt you want to use. Saved prompts appear alongside Agents in the @ menu.
  </Step>
  <Step title="Select your saved prompt">
    Click on the saved prompt to insert it into your chat
  </Step>
</Steps>

### Benefits of saved prompts

<Columns cols={2}>
  <Card title="Standardize queries" icon="check-double">
    Ensure consistent prompt quality across your team with pre-approved templates
  </Card>
  <Card title="Save time" icon="clock">
    Eliminate repetitive typing by reusing common prompts instantly
  </Card>
  <Card title="Share best practices" icon="users">
    Enable your entire team to benefit from optimized prompts created by experts
  </Card>
  <Card title="Maintain consistency" icon="equals">
    Keep your team aligned with standardized approaches to common tasks
  </Card>
</Columns>

<Tip>
Combine saved prompts with @ mentioned Agents for powerful, standardized workflows that leverage both reusable templates and specialized AI capabilities.
</Tip>
