...
You can select the LLM you want to use in Chat by following these steps:
...
You can choose different Chat modes to call your Agents. 

<Columns cols={2}>
    <Card title="Single Agent Mode" href="/chat/chat-modes/single-agent-mode" icon="person">
        Work with a single Agent in Chat
    </Card>
    <Card title="Multi Agent Mode" href="/chat/chat-modes/multi-agent-mode" icon="people">
        Work with multiple Agents in Chat
    </Card>
</Columns>
...
<AccordionGroup>
    ...
    <Accordion title="Can I call my Workforces in Chat?">We're working on adding this feature soon!</Accordion>
</AccordionGroup>