...
<AccordionGroup>
    ...
    **Important limitations:**
    - Chat Memory only remembers history within the same project
    - You can only access your own chat history, not other users' conversations in the same project

    <Note>
    This is different from Agent memory, which is conversation-specific memory within individual Agent interactions.
    </Note>
    </Accordion>
