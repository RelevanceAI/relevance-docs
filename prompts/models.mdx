...
| OpenAI    | GPT 4 NEW      | `openai-gpt4-0613`            |
| OpenAI    | GPT 3.5        | `openai-gpt35`                |
| OpenAI    | GPT 3.5 NEW    | `openai-gpt35-0613`           |
| OpenAI    | GPT 3.5 16k    | `openai-gpt35-16k `           |
| Anthropic | Claude         | `anthropic-claude-v1`         |
| Anthropic | Claude (100k)  | `anthropic-claude-v1-100k`    |
| Anthropic | Claude Instant | `anthropic-claude-instant-v1` |
| Anthropic | Claude Instant (100k) | `anthropic-claude-instant-v1-100k` |
