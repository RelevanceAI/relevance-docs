...
The Outlook integration allows your agent to receive all or some emails that are received to a specific Outlook account. For customer support agents that handle email equiries, we recommend setting up a dedicated email account for them, much like you would for a human employee.
