...
<Warning>
  User Level Authentication is an Enterprise-only feature that is gradually being rolled out to Enterprise customers. If you have an Enterprise subscription and don't have access yet, please reach out to your sales representative.
</Warning>
...
2. Navigate to the OAuth Input you want to enable Dynamic Auth on and click the authentication settings icon
3. Toggle on the switch next to 'User level authentication required'

<Note>
The shield icon only appears on OAuth account inputs. If you don't see the shield icon, your tool may be using API key authentication, which doesn't support User Level Authentication.
</Note>
...
<iframe src="https://app.supademo.com/embed/PLACEHOLDER-SETUP" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen allow="clipboard-write" style={{width: '100%', height: '600px'}}></iframe>

*This demo shows how to enable User Level Authentication on a tool equipped to an agent.*
...
<iframe src="https://app.supademo.com/embed/PLACEHOLDER-CHAT" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen allow="clipboard-write" style={{width: '100%', height: '600px'}}></iframe>

*This demo shows the user experience when using User Level Authentication in chat.*
...
<AccordionGroup>
  ...
  <Accordion title="Is this feature only available on Enterprise plans?">
    Yes, User Level Authentication is an Enterprise-only feature. It is currently being rolled out to Enterprise customers. If you have an Enterprise subscription and would like access to this feature, please reach out to your sales representative.
  </Accordion>
  ...
  <Accordion title="Why can't I enable User Level Authentication on my tool?">
    User Level Authentication only works with OAuth-based integrations. If you don't see the shield icon on your tool input, it's likely because:

    - Your tool uses API key authentication instead of OAuth
    - Your tool uses a Python code step
    - Your authentication is configured directly on the tool step (not as a tool input)
