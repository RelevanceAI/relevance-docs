...
<Info>
  Relevance AI agents can also connect to external MCP servers as clients. This lets your agents access tools from services like Linear, Notion, and GitHub. See [MCP Client](/integrations/mcp/mcp-client) for details on connecting external MCP servers to your agents.
</Info>
...
<AccordionGroup>
  ...
  <Accordion title="Can my Relevance AI agents connect to other MCP servers?">
    Yes. Relevance AI agents can act as MCP clients and connect to external MCP servers from services like Linear, Notion, and GitHub. This gives your agents access to tools from those platforms. See [MCP Client](/integrations/mcp/mcp-client) for setup instructions.
  </Accordion>
</AccordionGroup>
