...
When reading or listing agents via the API, each agent summary now includes a top-level `mcp_servers` field listing the MCP servers attached to that agent:
