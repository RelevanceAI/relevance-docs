...
The **Integrations & API Keys** page gives you access to over 2,000 integrations. Category tags and a search bar let you quickly narrow down the list to find what you need.

### Accessing the integrations browser

Navigate to **Integrations & API Keys** from the left-hand menu of your Relevance AI account. The browser displays all available integrations in a grid view.

### Filtering by category

Category tags at the top of the browser let you filter integrations by area of focus. Available categories include:

- **CRM** — customer relationship management platforms
- **Communication** — email, messaging, and video conferencing tools
- **AI Models** — LLM providers and AI services
- **Automation & Integration** — workflow automation and iPaaS platforms
- **Marketing & Growth** — campaign management and lead generation tools
- **Analytics & Business Intelligence** — reporting and data visualization services
- **Productivity & Collaboration** — document editing, project management, and team tools
- **Content Creation & Media** — design, video, and publishing platforms
- **Development & IT** — developer tools, cloud infrastructure, and IT services
- **Finance & Accounting** — invoicing, payments, and accounting software
- **Sales & CRM** — sales engagement and pipeline management tools

Click a category tag to show only integrations in that category. Click it again to remove the filter. Multiple tags can be selected at once.

### Native vs. Pipedream integrations

Integrations fall into two types, and you can filter by provider to see each group separately:
...
Use the search bar at the top of the integrations browser to find a specific service by name. The list updates as you type.

<Note>
If you're unsure which category an integration belongs to, use search — it queries across all categories simultaneously.
</Note>
