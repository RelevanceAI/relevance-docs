...
<Tip>
For teams, check out [Group Triggers](/build/agents/build-your-agent/agent-triggers/group-triggers) to share trigger configurations while team members use their own OAuth accounts.
</Tip>
...
[Group Triggers](/build/agents/build-your-agent/agent-triggers/group-triggers) - Share trigger configurations with your team while maintaining individual OAuth accounts.
...
<AccordionGroup>
  ...
  <Accordion title="What are Group Triggers?">
    Group Triggers allow admins to create shared trigger configurations that team members can join by connecting their own OAuth accounts. This eliminates duplicate setup while maintaining individual privacy. Learn more about [Group Triggers](/build/agents/build-your-agent/agent-triggers/group-triggers).
  </Accordion>
</AccordionGroup>
