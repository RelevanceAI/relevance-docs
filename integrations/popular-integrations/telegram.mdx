...
<Warning>The Telegram Trigger is considered a Premium trigger, and is available on the Pro plan (new pricing) and above. If you're on the old Pro plan, you'll gain access to this trigger when you move to the new Pro plan on your first renewal on or after December 1, 2025. If you use this Trigger, you will incur an additional 5000 credits per month for each connected account in your organization.</Warning>
