...
- **Manage Calendar Subscriptions**: Subscribe to and manage calendar subscriptions
- **Update Subscription Settings**: Configure subscription preferences
...
<Card title="Google Tasks" icon="list-check" href="/integrations/popular-integrations/google-tasks">
  Manage tasks alongside calendar events — create tasks from meetings or schedule events based on task deadlines
</Card>
