...
<AccordionGroup>
  <Accordion title="How do I send specific messages to someone on Slack?">If you want to be able to send a message to a specific person in Slack, that person will first need to send a message to the Relevance AI bot in Slack. 
  
  Once they do this, their name will appear as a destination option when sending Slack messages.</Accordion>
</AccordionGroup>
