---
title: 'Slack'
description: "Integration for Slack allows you to connect your Relevance AI agents with Slack, enabling seamless communication between your AI workforce and your team's Slack workspace."
sidebarTitle: 'Slack'
---

## Connect via Integration for Slack
...
<div
  ...
  <iframe
    src="https://app.supademo.com/embed/cmb77dn944hpdppkpmiavfbmi?v_email=EMAIL&embed_v=2"
    frameBorder="0"
    title="Relevanceai Demo"
...
<Warning>This feature may be deprecated in the future and an Agent Notification feature will be added instead.</Warning>
...
<div
  ...
  <iframe
    src="https://app.supademo.com/embed/cmb77xv6z4i8bppkpfd5ajd2i?v_email=EMAIL&embed_v=2"
    frameBorder="0"
...
## Agent Notifications
<Warning>This feature is currently in beta for some users</Warning>
...
<div
  ...
  <iframe
    src="https://app.supademo.com/embed/cmb77jbof4hqnppkpc1k339xb?v_email=EMAIL&embed_v=2"
    frameBorder="0"
    title="Connect Slack Agent Notifications"
    allow="clipboard-write"
    webkitallowfullscreen="true"
    mozallowfullscreen="true"
    allowfullscreen
...
<div
  ...
  <iframe
    src="https://app.supademo.com/embed/cmb781rbk4ie7ppkpcjfc5rdv?v_email=EMAIL&embed_v=2"
    frameBorder="0"
    title="Slack Tools - Send a Slack Message via a Tool Step"
    allow="clipboard-write"
    webkitallowfullscreen="true"
    mozallowfullscreen="true"
    allowfullscreen
...
* Outlook Integration - Combine integrations for Slack and Outlook to create comprehensive communication workflows that span both platforms.
* HubSpot Integration - Connect your communications via Slack with your CRM data to provide context-aware responses and updates.
