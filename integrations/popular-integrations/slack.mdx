...
<AccordionGroup>
  ...
  <Accordion title="What permissions do I need to trigger an agent via Slack DM?">
    ...
    **Who CAN trigger via DM:**
    - Asset Admins
    - Asset Members with Editor role
    - Project Admins
    - Project Editors
    
    **Who CANNOT trigger via DM:**
    - Asset Viewers
    - Project Members (without asset access)
    - Project Viewers
    
    If you're unable to trigger an agent via DM, check your permissions on the agent in Relevance AI. Learn more about permissions in our [RBAC documentation](https://relevanceai.com/docs/get-started/enterprise/rbac).
  </Accordion>
