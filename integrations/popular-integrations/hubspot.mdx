...
<iframe src="https://app.supademo.com/embed/clyxv4dq500wph5yzeoxmkrsd" frameBorder="0" title="Create an agent from scratch on Relevance AI" allow="clipboard-write; fullscreen" webkitAllowFullscreen="true" mozAllowFullscreen="true" allowFullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px" }} />
...
<Card title="HubSpot Assistant" icon="robot" href="/build/agents/assistants/hubspot-assistant">
  Want a ready-made solution? Check out our pre-built HubSpot Assistant from the Marketplace.
</Card>
...
<Tabs>
  <Tab title="Building a HubSpot-Triggered Agent">
    <Frame caption="In this video, our GTM Lead, Ahmed Alassafi, will show you how to build an Agent that is triggered from HubSpot.">
      <iframe
        className="w-full aspect-video rounded-xl"
        src="https://www.youtube.com/embed/0ag5lNlufYs"
  ...
  <Tab title="HubSpot Assistant Demo">
...
<Note>
Want an agent that manages your HubSpot CRM through plain English? Clone the [HubSpot pre-built agent](/integrations/pre-built-agents/hubspot-agent) from the Marketplace to handle contacts, deals, companies, and more through simple conversation.
</Note>
