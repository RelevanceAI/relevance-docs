...
The MCP Server integration enables you to use your Relevance AI Agents and tools in external AI clients that support the MCP (Model Control Protocol) standard. This powerful feature creates a seamless connection between your Relevance AI workspace and popular AI assistants like Claude and development environments like Cursor.
...
Agents can now connect to and run tools from remote MCP servers.
...
5. Add the details of your MCP Server here (URL and authentication details)
...
You can export your Relevance AI tools to an MCP Server. 
