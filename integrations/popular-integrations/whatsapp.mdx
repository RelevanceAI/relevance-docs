...
<AccordionGroup>
  ...
  <Accordion title="I received an email about a change to the WhatsApp integration. What do I need to do?">Our WhatsApp integration provider is shipping a change in mid-March 2026. If you're an existing user, you'll need to reconnect your WhatsApp account once the change takes effect. Please also note that previously threaded conversations will start on a new thread, as the underlying identifier format is changing. No action is needed until the change goes live — we'll follow up with further instructions.</Accordion>
</AccordionGroup>
