...
<iframe src="https://app.supademo.com/embed/cmmbbv5at0h2222c4i6gqpmdx?embed_v=2" frameBorder="0" title="Connect Microsoft Teams integration" allow="clipboard-write; fullscreen" webkitAllowFullscreen="true" mozAllowFullscreen="true" allowFullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px",objectFit:"cover" }} />
</div>
...
<Steps>
  ...
  <Step title="Add the Microsoft API Call tool step">
  ...
  <Step title="Configure the API endpoint">
    Configure the API endpoint, method, and parameters according to your needs. Refer to the [Microsoft Graph API documentation](https://learn.microsoft.com/en-us/graph/api/overview) for available endpoints and request formats.
  </Step>
...
<div style={{ width:"100%",position:"relative",paddingTop:"56.25%"}}>
<iframe src="https://app.supademo.com/embed/cmmbf6p5t0jtq22c4wyz5sug9?embed_v=2" frameBorder="0" title="Set up Microsoft Teams trigger" allow="clipboard-write; fullscreen" webkitAllowFullscreen="true" mozAllowFullscreen="true" allowFullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px",objectFit:"cover" }} />
</div>
