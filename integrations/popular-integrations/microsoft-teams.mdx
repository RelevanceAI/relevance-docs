...
<Info>
  **Looking to embed your chat app in Teams?** In addition to triggers and automation, you can also embed your Relevance AI chat app directly within Microsoft Teams as an iframe or tab. This provides a native Teams experience for direct user interaction. [Learn about Microsoft Teams embedding](/build/agents/share-your-agent/microsoft-teams-embedding).
</Info>
...
## Two ways to use Microsoft Teams with Relevance AI

<CardGroup cols={2}>
  <Card title="Triggers & Automation" icon="bolt">
    Set up triggers to automatically respond to Teams messages and use tool steps to send messages and manage channels. Perfect for automated workflows.
  </Card>
  <Card title="Embedded Chat App" icon="message" href="/build/agents/share-your-agent/microsoft-teams-embedding">
    Embed your Relevance AI chat app directly in Teams as an iframe or tab for direct user interaction. Great for support and knowledge access.
  </Card>
</CardGroup>

**Use both together:** Set up triggers for automated responses while also embedding a chat app for on-demand assistance!
...
<AccordionGroup>
  ...
  <Accordion title="What's the difference between embedding and the Teams integration?">
    The Teams integration (this page) is for automation—setting up triggers to respond to messages and using tool steps to send messages. Embedding is for direct user interaction—adding your chat app as an iframe or tab in Teams so users can chat with your agent. You can use both approaches together! Learn more about [Microsoft Teams embedding](/build/agents/share-your-agent/microsoft-teams-embedding).
  </Accordion>
</AccordionGroup>
