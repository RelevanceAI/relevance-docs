...
<AccordionGroup>
  <Accordion title="What permissions does Relevance AI need for the Gmail integration?">Relevance AI requires permission to read, send, and manage your emails to provide full functionality. You can review these permissions during the connection process.</Accordion>
...
<Note>
Want an agent that can handle any Gmail task through plain English? Clone the [Gmail pre-built agent](/integrations/pre-built-agents/gmail-agent) from the Marketplace to search, send, organize, and manage your inbox through simple conversation.
</Note>
