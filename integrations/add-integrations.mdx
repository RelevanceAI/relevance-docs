...
2. Browse the available integrations and select the service you want to connect. Use the category tags or search bar to narrow down the list — over 2,000 integrations are available. For details on filtering options, see [Browsing and filtering integrations](/integrations/introduction#browsing-and-filtering-integrations).
