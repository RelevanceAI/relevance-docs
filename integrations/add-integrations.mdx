...
<Tip>
  When working in Invent, you can manage integrations directly from the chat without navigating here. See [Connected accounts](/build/invent/invent#connected-accounts) for details.
</Tip>
