...
you data.
* Black: to create and empty table
...
![Upload data](/images/data-table/data-create-a-table.png)
...
![Upload data](/images/data-table/data-upload1.png)
...
![Enable knowledge](/images/data-table/enable-knowledge.png)
...
Note that only knowledge enabled data can be used for further analysis.
    ...
    <p align="center">
    <img width="500" height="300" align="center" src="/images/data-table/knowledge-enabled-data.png" />
    </p>