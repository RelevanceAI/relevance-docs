...
![Text inputs](/images/custom-tools/components/user-input/file-to-text-input-1.png)
...
![Text inputs](/images/custom-tools/components/user-input/file-to-text-input-details1.png)
