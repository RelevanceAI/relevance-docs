...
In the following subsections and pages, we explain all required steps and all the
available components to create a Tool.

<Tip>
Tools that you design are saved under the `Tools` menu. Also listed on the `Home` 
page.
</Tip>