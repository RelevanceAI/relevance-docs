...
Most features work the same as on [chat.relevanceai.com](https://chat.relevanceai.com), so workflows you've already set up keep working on mobile. This page covers what's different, including [mobile-only features](#what’s-available-on-mobile) and [features that aren't available yet](#what’s-available-on-mobile).
