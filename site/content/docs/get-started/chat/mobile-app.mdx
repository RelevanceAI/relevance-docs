...
Most features work the same as on [chat.relevanceai.com](https://chat.relevanceai.com), so workflows you've already set up keep working on mobile. This page covers what's different, including [mobile-only features](#mobile-only-features) and [what works the same as Chat on web](#what-works-the-same-as-chat-on-web).
...
<CardGroup cols={2}>
  <Card title="Inside a chat" icon="plus">
  ...
  <Card title="Between chats" icon="bars">
...
<div style={{ width:"100%",position:"relative","padding-top":"100%" }}>
<iframe src="https://app.supademo.com/embed/cmpnl793w005c0v0jtmim72qq" frameBorder="0" title="Signing out of the Relevance Chat mobile app" allow="clipboard-write; fullscreen" webkitAllowFullscreen="true" mozAllowFullscreen="true" allowFullscreen style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"3px solid #5E43CE",borderRadius:"10px" }} />
</div>
...
<AccordionGroup>
  ...
  <Accordion title="Where do I find the settings menu?">
  ...
  <Accordion title="How do I see the app version?">
  ...
  <Accordion title="Are Edge regions available on mobile?">
    No. US Edge, AU Edge, and EU Edge are only available in the [Chat browser extension and desktop app](/admin/project-management/switch-projects#switching-projects-in-chat).
  </Accordion>
