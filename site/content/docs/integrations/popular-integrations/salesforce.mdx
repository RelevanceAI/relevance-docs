...
<img src="/images/get_contact.png" alt="The Salesforce tool step for retrieving an existing contact's details" />

### Create a new Lead.

<img src="/images/create_new_lead.png" alt="The Salesforce tool step for creating a new lead" />

### Create a note (e.g. lead qual research).

<img src="/images/create_note.png" alt="The Salesforce tool step for creating a note" />

### Create a task

<img src="/images/create_task.png" alt="The Salesforce tool step for creating a task" />

### Mark a task as complete

<img src="/images/complete_task.png" alt="The Salesforce tool step for marking a task complete" />
