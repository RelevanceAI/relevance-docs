...
1. Start with clicking on `+ Create tool` located on top right of the [Tools](/get-started/core-concepts/tools) page.
For more information see [how to create a tool](/build/tools/create-a-tool).
2. Click on `+ Add data` on the knowledge section to [add knowledge](/build/tools/knowledge/knowledge) to your Tool. 
...
<Tip>
Make sure to [enable knowledge](/build/knowledge/create-knowledge) (i.e. vectorize your data). Vectors allow semantic 
search (as opposed to word-matching) and increase the accuracy of knowledge retrieval. 
</Tip>
3. Add a [text input](/build/tools/user-inputs/text-input) component which will carry the query/question. Lets call
...
4. Add an [LLM](/build/tools/tool-steps/llms/llm-tool-step) component.
* **The prompt**
