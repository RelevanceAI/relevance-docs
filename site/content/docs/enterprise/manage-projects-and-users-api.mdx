---
title: "Managing projects and users with the API"
sidebarTitle: "Managing projects and users with the API"
description: "Use the API to create projects, manage invites, and control user access"
---
