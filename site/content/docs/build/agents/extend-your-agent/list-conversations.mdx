...
<include>../../../../_snippets/api-auth-setup.mdx</include>

## Agent Id
<include>../../../../_snippets/agent-id.mdx</include>

## Conversation Id
<include>../../../../_snippets/conversation-id.mdx</include>
...
response = requests.post(
  base_url+"/build/knowledge/sets/list", 
  headers=headers, 
  json={
