...
![](/images/agent/variables_new.png)
...
<Note>For more detailed information about data types and how they function, check out our [Inputs page](https://relevanceai.com/docs/build/tools/customize-tool/inputs).</Note>
