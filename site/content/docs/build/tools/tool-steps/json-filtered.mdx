...
However, it is often more practical to fetch the value from an input component (e.g. [JSON input](/build/tools/user-inputs/json)) or 
another step output (e.g. [String to JSON](/build/tools/tool-steps/llms/llm-tool-step)). 
