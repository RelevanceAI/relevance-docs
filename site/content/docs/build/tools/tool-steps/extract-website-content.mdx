...
[Firecrawl](/build/tools/tool-steps/firecrawl) is another Tool step you can use to scrape and extract website content. Unlike this Tool step, it requires you to sign up for [Firecrawl](https://firecrawl.dev) and bring your Firecrawl API Key - however, it comes with more options for scraping outputs. 
