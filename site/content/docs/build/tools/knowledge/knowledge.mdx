...
<Frame caption="Screenshot of Add Data modal for Knowledge">
  <img src="/images/knowledge-modal.png" alt="The Add data modal, offering an uploaded file, a website crawl, a third-party integration or an existing dataset" />
</Frame>
...
<Tip>You can check the context limit of models [here](/build/tools/tool-steps/llms/models).</Tip>
