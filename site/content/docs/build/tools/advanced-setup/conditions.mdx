...
Access loops under the three-dot menu on the top right of steps. Click on **Enable conditions**.
  ...
  <p align="center">
  <img width="350" height="150" align="center" src="/images/build-custom-tools/tool-step/add-delete-condition-loop.png" alt="The three-dot step menu open, showing Enable conditions and the loop options" />
  </p>
...
<Frame caption="Screenshot of the Conditions input in a step">
  <img src="/images/conditions.png" alt="The Conditions input on a step, holding a template expression" />
</Frame>