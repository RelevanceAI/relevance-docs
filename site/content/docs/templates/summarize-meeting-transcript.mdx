...
1. <include>../../_snippets/components/inputs/long-text-input.mdx</include>
    This component is to provide the transcription and is of type long tex inputs.

2. <include>../../_snippets/components/inputs/text-input.mdx</include>
    This component is to briefly overview the meeting agenda and is of Text input type.

3. <include>../../_snippets/components/inputs/table.mdx</include>
