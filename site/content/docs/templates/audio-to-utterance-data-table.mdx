...
<include>../../_snippets/audio-trim-speaker1.mdx</include>
...
<include>../../_snippets/bulk-run-for-audio.mdx</include>
...
2. Use the resulting table as [knowledge](/build/tools/knowledge/knowledge) in a Tool similar to 
