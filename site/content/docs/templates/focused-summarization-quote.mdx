...
<Warning>
**You MUST first create a dataset of selected utterances** 
...
By customizing the knowledge set, you can ensure that the Tool is not limited to one or a restricted set of interviews.
...
* **Provide knowledge**: You need to provide the name of your utterance data table to be used as knowledge.
We highly recommend using Copy-Paste. 
The spelling of the knowledgeset name must be EXACTLY as seen on top of the Data table page.
