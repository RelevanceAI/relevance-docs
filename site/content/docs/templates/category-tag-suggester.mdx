...
4. <include>../../_snippets/components/inputs/numeric-input.mdx</include>
...
<include>../../_snippets/components/tools/convert-spreadsheet-to-json.mdx</include>
...
<include>../../_snippets/components/tools/code-python.mdx</include>
