...
<p align="center">
<img width="500" height="300" align="center" src="/images/build-custom-tools/tool-step/configure-output.png" alt="The output configuration panel for a step" />
</p>
...
More details are available at [Output Configuration](/build/tools/advanced-setup/output-configuration).
